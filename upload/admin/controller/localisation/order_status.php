...
class ControllerLocalisationOrderStatus extends Controller { 
	private $error = array();
  	...
  	protected function getList() {
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($order_status_total) ? (($page - 1) * $this->config->get('config_admin_limit')) + 1 : 0, ((($page - 1) * $this->config->get('config_admin_limit')) > ($order_status_total - $this->config->get('config_admin_limit'))) ? $order_status_total : ((($page - 1) * $this->config->get('config_admin_limit')) + $this->config->get('config_admin_limit')), $order_status_total, ceil($order_status_total / $this->config->get('config_admin_limit')));
