...
$_['error_name']             = 'Error: name is missing in install.json';
$_['error_version']          = 'Error: version is missing in install.json';
$_['error_codename']             = 'Error: codename is missing in install.json';