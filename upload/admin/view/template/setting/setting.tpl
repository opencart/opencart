            ...
            <div class="tab-pane" id="tab-mail">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                     <textarea name="config_mail_alert_email" rows="5" placeholder="<?php echo $entry_mail_alert_email; ?>" id="input-mail-alert-email" class="form-control"><?php echo $config_mail_alert_email; ?></textarea>
                  </div>
                </div>
              </fieldset>
            </div>
