...
class ControllerCatalogDownload extends Controller {
	...
	protected function validateForm() {
		...
		foreach ($this->request->post['download_description'] as $language_id => $value) {
			if ((utf8_strlen(trim($value['name'])) < 3) || (utf8_strlen(trim($value['name'])) > 64)) {
		...
		if ((utf8_strlen(trim($this->request->post['mask'])) < 3) || (utf8_strlen(trim($this->request->post['mask'])) > 128)) {
