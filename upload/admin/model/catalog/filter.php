...
class ModelCatalogFilter extends Model {
	public function addFilter($data) {
		$this->event->trigger('pre.filter.add', $data);
		...
		$this->event->trigger('post.filter.add', $filter_id);

		return $filter_id;
	}

	public function editFilter($filter_group_id, $data) {
		$this->event->trigger('pre.filter.edit', $data);
		...
		$this->event->trigger('post.filter.edit', $filter_group_id);
	}

	public function deleteFilter($filter_group_id) {
		$this->event->trigger('pre.filter.delete', $filter_group_id);
		...
		$this->event->trigger('post.filter.delete', $filter_group_id);
	}
