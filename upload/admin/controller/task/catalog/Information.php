...
class Information extends \Opencart\System\Engine\Controller {
	...
	public function list(array $args = []): array {
		...
		$directory = DIR_OPENCART . 'shop/' . parse_url($store_info['url'], PHP_URL_HOST) . '/data/catalog/information/';
	...
	public function delete(array $args = []): array {
		...
		$file = DIR_OPENCART . 'shop/' . parse_url($store_info['url'], PHP_URL_HOST) . '/data/catalog/information/information-' . (int)$args['information_id'] . '.json';
