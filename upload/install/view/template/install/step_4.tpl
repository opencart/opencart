...
<div class="container">
  ...
  <div class="visit">
    <div class="row">
      <div class="col-sm-5 col-sm-offset-1 text-center">
        <p><i class="mi mi-shopping-cart mi-5x">shopping_cart</i></p>
        <a href="../" class="btn btn-secondary"><?php echo $text_catalog; ?></a></div>
      <div class="col-sm-5 text-center">
        <p><i class="mi mi-cog mi-5x white">settings</i></p>
        <a href="../admin/" class="btn btn-secondary"><?php echo $text_admin; ?></a></div>
    </div>
  </div>
  <div class="modules">
    <div class="row" id="extension">
      <h2 class="text-center"><i class="mi mi-circle-o-notch mi-spin">refresh</i> <?php echo $text_loading; ?></h2>
    </div>
    <div class="row">
  ...
  <div class="mailing">
    <div class="row">
      <div class="col-sm-12"><i class="mi mi-envelope-o mi-5x">mail_outline</i>
  ...
  <div class="support text-center">
    <div class="row">
      <div class="col-sm-4"><a href="https://www.facebook.com/pages/OpenCart/477182382328323" class="icon transition"><i class="mi mi-facebook mi-4x"></i></a>
      ...
      <div class="col-sm-4"><a href="http://forum.opencart.com/?utm_source=opencart_install&utm_medium=forum_link&utm_campaign=opencart_install" class="icon transition"><i class="mi mi-comments mi-4x">forum</i></a>
      ...
      <div class="col-sm-4"><a href="http://www.opencart.com/index.php?route=partner/partner&utm_source=opencart_install&utm_medium=partner_link&utm_campaign=opencart_install" class="icon transition"><i class="mi mi-user mi-4x">person</i></a>
