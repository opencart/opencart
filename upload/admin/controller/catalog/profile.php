...
class ControllerCatalogProfile extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/profile', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $profile_id) {
			$product_total = $this->model_catalog_product->getTotalProductsByProfileId($profile_id);
