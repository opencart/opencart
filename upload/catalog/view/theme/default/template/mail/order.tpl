...
<div style="width: 680px;"><a href="{{ store_url }}" title="{{ store_name }}"><img src="<?php echo $logo; ?>" alt="{{ store_name }}" style="margin-bottom: 20px; border: none;" /></a>
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    ...
    <tbody>
      <tr>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b>{{ text_order_id }}</b> <?php echo $order_id; ?><br />
        ...
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b>{{ text_email }}</b> {{ email }}<br />
          <b>{{ text_telephone }}</b> <?php echo $telephone; ?><br />
          <b>{{ text_ip }}</b> <?php echo $ip; ?><br />
          <b>{{ text_order_status }}</b> <?php echo $order_status; ?><br /></td>
      </tr>
    </tbody>
  </table>
  <?php if ($comment) { ?>
