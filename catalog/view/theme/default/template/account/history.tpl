...
<div class="middle">
  ...
  <div style="display: inline-block; margin-bottom: 10px; width: 100%;">
    <div style="width: 49%; float: left; margin-bottom: 3px;"><b><?php echo $text_order; ?></b> #<?php echo $order['order_id']; ?></div>
    <div style="width: 49%; float: right; margin-bottom: 3px; text-align: right;"><b><?php echo $text_status; ?></b> <?php echo $order['status']; ?></div>
      ...
      <div style="padding: 5px;">
        <table width="100%">
          <tr>
            ...
            <td rowspan="2"><a onclick="location='<?php echo $order['href']; ?>'" class="button"><span><?php echo $button_view; ?></span></a></td>
          </tr>
          <tr>
