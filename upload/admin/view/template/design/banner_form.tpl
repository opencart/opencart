...
function addImage() {
	...
	html += '  <td class="text-right"><input type="text" name="banner_image[' + image_row + '][sort_order]" value="' + (image_row+1) + '" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
