...
class ControllerModuleMostReviewed extends Controller {
	public function index($setting) {
		...
		$totresults = $this->model_catalog_product->getTotResults();
		$data['mostreviewedaggregate'] = sprintf($this->language->get('text_mostreviewed'), $totresults[0], round($totresults[1],1));
		
		$data['products'] = array();

		$results = $this->model_catalog_product->getMostReviewedProducts($setting['limit']);
