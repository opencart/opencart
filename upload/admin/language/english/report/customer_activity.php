...
$_['text_fogotten']       = '<a href="customer_id=%d">%s</a> has requested a new password.';
...
$_['text_return_accout']  = '<a href="customer_id=%d">%s</a> has just submitted a product return.';
$_['text_return_guest']   = '%s %s has just submitted a product return.';
$_['text_order_accout']   = '<a href="customer_id=%d">%s</a> has just created a <a href="order_id=%d">new order</a>.';
$_['text_order_guest']    = '%s has just created a <a href="order_id=%d">new order</a>.';
