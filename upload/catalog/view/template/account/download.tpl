...
<div class="middle">
  ...
  <div style="display: inline-block; margin-bottom: 10px; width: 100%;">
    <div style="width: 45%; float: left; margin-bottom: 3px;"><b><?php echo $text_order; ?></b> <?php echo $download['order_id']; ?></div>
    <div style="width: 45%; float: right; margin-bottom: 3px; text-align: right;"><b><?php echo $text_size; ?></b> <?php echo $download['size']; ?></div>
      ...
      <div style="padding: 5px;">
        <table width="100%">
          <tr>
            ...
            <td rowspan="2"><a onclick="location='<?php echo $download['href']; ?>'" class="button"><span><?php echo $text_download; ?></span></a></td>
          </tr>
          <tr>
