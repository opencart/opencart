...
class Returns extends \Opencart\System\Engine\Controller {
	...
	public function add(): void {
		...
		if ($information_info) {
			$data['text_agree'] = $this->language->format('text_agree', $this->url->link('information/information.info', 'language=' . $this->config->get('config_language') . '&information_id=' . $this->config->get('config_return_id')), $information_info['title']);
		} else {
			$data['text_agree'] = '';
		}
