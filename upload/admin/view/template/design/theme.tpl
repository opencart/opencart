          ...
          <div class="col-lg-9 col-md-9 col-sm-12">
            ...
            <div id="warning">
              <div class="alert alert-warning">
                <h4><i class="mi mi-exclamation-circle">error</i> <?php echo $text_warning; ?></h4>
                <p><?php echo $text_access; ?></p>
                <p><?php echo $text_permission; ?></p>
              </div>
              <div class="alert alert-info">
                <p><i class="mi mi-info-circle">info</i> <?php echo $text_begin; ?></p>
              </div>
            </div>
          </div>
        </div>
		...
		$.ajax({
			...
			success: function(json) {
				if (json['code']) {
					...
					$('.nav-tabs').append('<li><a href="#tab-' + tab_id + '" data-toggle="tab">' + $(node).attr('href').split('/').join(' / ') + '&nbsp;&nbsp;<i class="mi mi-minus-circle">remove circle</i></a></li>');
					...
					html += '    <button type="button" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="mi mi-floppy-o">save</i> <?php echo $button_save; ?></button>';
					html += '    <button type="button" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-danger"><i class="mi mi-recycle">sync</i> <?php echo $button_reset; ?></button>';
					html += '  </div>';
					html += '</div>';
...
$('.nav-tabs').on('click', 'i.mi-minus-circle', function(e) {
	e.preventDefault();
