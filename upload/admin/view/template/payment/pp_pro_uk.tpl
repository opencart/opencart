  ...
  <div class="panel">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-pp-pro-uk" class="form-horizontal">
      <div class="form-group required">
        <label class="col-lg-3 control-label" for="input-vendor"><?php echo $entry_vendor; ?> <span class="help-block"><?php echo $help_vendor; ?></span></label>
        <div class="col-lg-9">
      ...
      <div class="form-group required">
        <label class="col-lg-3 control-label" for="input-user"><?php echo $entry_user; ?> <span class="help-block"><?php echo $help_user; ?></span></label>
        <div class="col-lg-9">
      ...
      <div class="form-group required">
        <label class="col-lg-3 control-label" for="input-partner"><?php echo $entry_partner; ?> <span class="help-block"><?php echo $help_partner; ?></span></label>
        <div class="col-lg-9">
