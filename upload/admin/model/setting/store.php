...
class ModelSettingStore extends Model {
	public function addStore($data) {
		$this->event->trigger('pre.store.add', $data);
		...
		$this->event->trigger('post.store.add', $store_id);

		return $store_id;
	}

	public function editStore($store_id, $data) {
		$this->event->trigger('pre.store.edit', $data);
		...
		$this->event->trigger('post.store.edit', $store_id);
	}

	public function deleteStore($store_id) {
		$this->event->trigger('pre.store.delete', $store_id);
		...
		$this->event->trigger('post.store.delete', $store_id);
	}
