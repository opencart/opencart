...
class Currency extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('localisation/currency', $url)
		];

		$data['refresh'] = $this->url->link('localisation/currency.refresh', $url);
		$data['add'] = $this->url->link('localisation/currency.form', $url);
	...
	protected function getList(): string {
		...
		$data['action'] = $this->url->link('localisation/currency.list', $url);
		...
		foreach ($results as $result) {
			$data['currencies'][] = [
				...
				'edit'          => $this->url->link('localisation/currency.form', 'currency_id=' . $result['currency_id'] . $url)
			];
		}
		...
		$data['sort_title'] = $this->url->link('localisation/currency.list', 'sort=title' . $url);
		$data['sort_code'] = $this->url->link('localisation/currency.list', 'sort=code' . $url);
		$data['sort_value'] = $this->url->link('localisation/currency.list', 'sort=value' . $url);
		$data['sort_status'] = $this->url->link('localisation/currency.list', 'sort=status' . $url);
		$data['sort_date_modified'] = $this->url->link('localisation/currency.list', 'sort=date_modified' . $url);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('localisation/currency.list', $url . '&page={page}')
		]);
	...
	public function form(): void {
		...
		$data['save'] = $this->url->link('localisation/currency.save');
		$data['back'] = $this->url->link('localisation/currency', $url);
