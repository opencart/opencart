...
INSERT INTO `oc_category` (`category_id`, `image`, `parent_id`, `column`, `sort_order`, `status`, `date_added`, `date_modified`)
VALUES (25, '', 0, 1, 3, 1, '2009-01-31 01:04:25', '2011-05-30 12:14:55'),
       (27, '', 20, 0, 2, 1, '2009-01-31 01:55:34', '2010-08-22 06:32:15'),
       (20, 'catalog/demo/compaq_presario.jpg', 0, 1, 1, 1, '2009-01-05 21:49:43', '2011-07-16 02:14:42'),
       (24, '', 0, 1, 5, 1, '2009-01-20 02:36:26', '2011-05-30 12:15:18'),
       (18, 'catalog/demo/hp_2.jpg', 0, 1, 2, 1, '2009-01-05 21:49:15', '2011-05-30 12:13:55'),
       (17, '', 0, 1, 4, 1, '2009-01-03 21:08:57', '2011-05-30 12:15:11'),
       (28, '', 25, 0, 1, 1, '2009-02-02 13:11:12', '2010-08-22 06:32:46'),
       (26, '', 20, 0, 1, 1, '2009-01-31 01:55:14', '2010-08-22 06:31:45'),
       (29, '', 25, 0, 1, 1, '2009-02-02 13:11:37', '2010-08-22 06:32:39'),
       (30, '', 25, 0, 1, 1, '2009-02-02 13:11:59', '2010-08-22 06:33:00'),
       (31, '', 25, 0, 1, 1, '2009-02-03 14:17:24', '2010-08-22 06:33:06'),
       (32, '', 25, 0, 1, 1, '2009-02-03 14:17:34', '2010-08-22 06:33:12'),
       (33, '', 0, 1, 6, 1, '2009-02-03 14:17:55', '2011-05-30 12:15:25'),
       (34, 'catalog/demo/ipod_touch_4.jpg', 0, 1, 7, 1, '2009-02-03 14:18:11', '2011-05-30 12:15:31'),
       (35, '', 28, 0, 0, 1, '2010-09-17 10:06:48', '2010-09-18 14:02:42'),
       (36, '', 28, 0, 0, 1, '2010-09-17 10:07:13', '2010-09-18 14:02:55'),
       (37, '', 34, 0, 0, 1, '2010-09-18 14:03:39', '2011-04-22 01:55:08'),
       (38, '', 34, 0, 0, 1, '2010-09-18 14:03:51', '2010-09-18 14:03:51'),
       (39, '', 34, 0, 0, 1, '2010-09-18 14:04:17', '2011-04-22 01:55:20'),
       (40, '', 34, 0, 0, 1, '2010-09-18 14:05:36', '2010-09-18 14:05:36'),
       (41, '', 34, 0, 0, 1, '2010-09-18 14:05:49', '2011-04-22 01:55:30'),
       (42, '', 34, 0, 0, 1, '2010-09-18 14:06:34', '2010-11-07 20:31:04'),
       (43, '', 34, 0, 0, 1, '2010-09-18 14:06:49', '2011-04-22 01:55:40'),
       (44, '', 34, 0, 0, 1, '2010-09-21 15:39:21', '2010-11-07 20:30:55'),
       (45, '', 18, 0, 0, 1, '2010-09-24 18:29:16', '2011-04-26 08:52:11'),
       (46, '', 18, 0, 0, 1, '2010-09-24 18:29:31', '2011-04-26 08:52:23'),
       (47, '', 34, 0, 0, 1, '2010-11-07 11:13:16', '2010-11-07 11:13:16'),
       (48, '', 34, 0, 0, 1, '2010-11-07 11:13:33', '2010-11-07 11:13:33'),
       (49, '', 34, 0, 0, 1, '2010-11-07 11:14:04', '2010-11-07 11:14:04'),
       (50, '', 34, 0, 0, 1, '2010-11-07 11:14:23', '2011-04-22 01:16:01'),
       (51, '', 34, 0, 0, 1, '2010-11-07 11:14:38', '2011-04-22 01:16:13'),
       (52, '', 34, 0, 0, 1, '2010-11-07 11:16:09', '2011-04-22 01:54:57'),
       (53, '', 34, 0, 0, 1, '2010-11-07 11:28:53', '2011-04-22 01:14:36'),
       (54, '', 34, 0, 0, 1, '2010-11-07 11:29:16', '2011-04-22 01:16:50'),
       (55, '', 34, 0, 0, 1, '2010-11-08 10:31:32', '2010-11-08 10:31:32'),
       (56, '', 34, 0, 0, 1, '2010-11-08 10:31:50', '2011-04-22 01:16:37'),
       (57, '', 0, 1, 3, 1, '2011-04-26 08:53:16', '2011-05-30 12:15:05'),
       (58, '', 52, 0, 0, 1, '2011-05-08 13:44:16', '2011-05-08 13:44:16');
...
VALUES (1, 1, 'Afghanistan'),
       ...
       (114, 1, 'Kuwait'),
       (115, 1, 'Kyrgyzstan'),
       (116, 1, 'Lao Peopleʼs Democratic Republic'),
       (117, 1, 'Latvia'),
       (118, 1, 'Lebanon'),
       (119, 1, 'Lesotho'),
       (120, 1, 'Liberia'),
       ...
       (177, 1, 'Rwanda'),
       (178, 1, 'Saint-Kitts-et-Nevis'),
       (179, 1, 'Sainte-Lucie'),
       (180, 1, 'aint-Vincent-et-les Grenadines'),
       (181, 1, 'Samoa'),
       (182, 1, 'San Marino'),
...
VALUES (3093, 1, 'Västmanland'),
       ...
       (4257, 1, 'Republic of Adygea'),
       (4258, 1, 'Republic of Bashkortostan'),
       (4259, 1, 'Republic of Buryatia'),
       (4260, 1, 'Altai Republic'),
       (4261, 1, 'Republic of Dagestan'),
       (4262, 1, 'Republic of Ingushetia'),
       (4263, 1, 'Kabardino-Balkar Republic'),
       (4264, 1, 'Republic of Kalmykia'),
       (4265, 1, 'Karachay-Cherkess Republic'),
       (4266, 1, 'Republic of Karelia'),
       (4267, 1, 'Komi Republic'),
       (4268, 1, 'Mari El Republic'),
       (4269, 1, 'Republic of Mordovia'),
       (4270, 1, 'Sakha (Yakutia) Republic'),
       (4271, 1, 'Republic of North Ossetia-Alania'),
       (4272, 1, 'Republic of Tatarstan'),
       (4273, 1, 'Tuva Republic'),
       (4274, 1, 'Udmurt Republic'),
       (4275, 1, 'Republic of Khakassia'),
       ...
       (4342, 1, 'Ladakh'),
       (4343, 1, 'Uttarakhand'),
       (4344, 1, 'Mecklenburg-Vorpommern, Ahrendsberg (Ostsee)'),
       (4345, 1, 'Mecklenburg-Vorpommern, Balmer Werder (Ostsee)'),
       (4346, 1, 'Mecklenburg-Vorpommern, Barther Oie (Ostsee)'),
       (4347, 1, 'Mecklenburg-Vorpommern, Baumwerder (Ostsee)'),
       (4348, 1, 'Mecklenburg-Vorpommern, Beuchel (Ostsee)'),
       (4349, 1, 'Mecklenburg-Vorpommern, Bock (Ostsee)'),
       (4350, 1, 'Mecklenburg-Vorpommern, Brinkenberg (Ostsee)'),
       (4351, 1, 'Mecklenburg-Vorpommern, Bullenriff o. Kuhwerder (Ostsee)'),
       (4352, 1, 'Mecklenburg-Vorpommern, Böhmke (Ostsee)'),
       (4353, 1, 'Mecklenburg-Vorpommern, Dänholm (Kröslin, Ostsee)'),
       (4354, 1, 'Mecklenburg-Vorpommern, Dänholm (Ostsee)'),
       (4355, 1, 'Mecklenburg-Vorpommern, Fährinsel (Ostsee)'),
       (4356, 1, 'Schleswig-Holstein, Fehmarn (Ostsee)'),
       (4357, 1, 'Mecklenburg-Vorpommern, Gänsewerder (Ostsee)'),
       (4358, 1, 'Mecklenburg-Vorpommern, Görmitz (Ostsee)'),
       (4359, 1, 'Mecklenburg-Vorpommern, Greifswalder Oie (Ostsee)'),
       (4360, 1, 'Mecklenburg-Vorpommern, Großer Werder (Zingst, Ostsee)'),
       (4361, 1, 'Mecklenburg-Vorpommern, Großer Wotig (Ostsee)'),
       (4362, 1, 'Mecklenburg-Vorpommern, Grot Deil (Ostsee)'),
       (4363, 1, 'Mecklenburg-Vorpommern, Heuwiese (Ostsee)'),
       (4364, 1, 'Mecklenburg-Vorpommern, Hiddensee, MV (Ostsee)'),
       (4365, 1, 'Mecklenburg-Vorpommern, Kastenwerder (Ostsee)'),
       (4366, 1, 'Mecklenburg-Vorpommern, Kieler Ort (Ostsee)'),
       (4367, 1, 'Mecklenburg-Vorpommern, Kirr (Ostsee)'),
       (4368, 1, 'Mecklenburg-Vorpommern, Kleiner Rohrplan (Ostsee)'),
       (4369, 1, 'Mecklenburg-Vorpommern, Kleiner Werder (Ostsee)'),
       (4370, 1, 'Mecklenburg-Vorpommern, Kleiner Wotig (Ostsee)'),
       (4371, 1, 'Mecklenburg-Vorpommern, Kleine Werder (Ostsee)'),
       (4372, 1, 'Mecklenburg-Vorpommern, Koos (Ostsee)'),
       (4373, 1, 'Mecklenburg-Vorpommern, Langenwerder (Ostsee)'),
       (4374, 1, 'Mecklenburg-Vorpommern, Liebes (Ostsee)'),
       (4375, 1, 'Mecklenburg-Vorpommern, Liebitz (Ostsee)'),
       (4376, 1, 'Mecklenburg-Vorpommern, Mährens (Ostsee)'),
       (4377, 1, 'Mecklenburg-Vorpommern, Öhe (Ostsee)'),
       (4378, 1, 'Mecklenburg-Vorpommern, Poel (Ostsee)'),
       (4379, 1, 'Mecklenburg-Vorpommern, Prosnitzer o. Gustower Werder (Ostsee)'),
       (4380, 1, 'Mecklenburg-Vorpommern, Riems (Ostsee)'),
       (4381, 1, 'Mecklenburg-Vorpommern, Riffbrink (Ostsee)'),
       (4382, 1, 'Mecklenburg-Vorpommern, Riether Werder (Ostsee)'),
       (4383, 1, 'Mecklenburg-Vorpommern, Ruden (Ostsee)'),
       (4384, 1, 'Mecklenburg-Vorpommern, Rügen (Ostsee)'),
       (4385, 1, 'Mecklenburg-Vorpommern, Schlossinsel (Ostsee)'),
       (4386, 1, 'Mecklenburg-Vorpommern, Struck (Halbinsel, Ostsee)'),
       (4387, 1, 'Mecklenburg-Vorpommern, Tedingsinsel (Ostsee)'),
       (4388, 1, 'Mecklenburg-Vorpommern, Tollow (Ostsee)'),
       (4389, 1, 'Mecklenburg-Vorpommern, Ummanz (Ostsee)'),
       (4390, 1, 'Mecklenburg-Vorpommern, Urkevitz (Ostsee)'),
       (4391, 1, 'Mecklenburg-Vorpommern, Usedom (Ostsee)'),
       (4392, 1, 'Mecklenburg-Vorpommern, Vilm (Ostsee)'),
       (4393, 1, 'Mecklenburg-Vorpommern, Vogelinsel o. Vauglinsel (Ostsee)'),
       (4394, 1, 'Mecklenburg-Vorpommern, Walfisch (Ostsee)'),
       (4395, 1, 'Schleswig-Holstein, Warder (Ostsee)'),
       (4396, 1, 'Mecklenburg-Vorpommern, Weidenschwanz (Ostsee)'),
       (4397, 1, 'Mecklenburg-Vorpommern, Werder (Ostsee)'),
       (4398, 1, 'Mecklenburg-Vorpommern, Wührens (Ostsee)'),
       (4399, 1, 'Schleswig-Holstein, Amrum (Nordsee)'),
       (4400, 1, 'Schleswig-Holstein, Föhr (Nordsee)'),
       (4401, 1, 'Schleswig-Holstein, Pellworm (Nordsee)'),
       (4402, 1, 'Schleswig-Holstein, Sylt (Nordsee)'),
       (4403, 1, 'Schleswig-Holstein, Uthörn (Sylt, Nordsee)'),
       (4404, 1, 'Schleswig-Holstein, Gröde (Hallig)'),
       (4405, 1, 'Schleswig-Holstein, Habel (Hallig)'),
       (4406, 1, 'Schleswig-Holstein, Hooge (Hallig, Nordsee)'),
       (4407, 1, 'Schleswig-Holstein, Hamburger Hallig'),
       (4408, 1, 'Schleswig-Holstein, Langeneß (Hallig, Nordsee)'),
       (4409, 1, 'Schleswig-Holstein, Nordstrandischmoor (Hallig)'),
       (4410, 1, 'Schleswig-Holstein, Oland (Hallig)'),
       (4411, 1, 'Schleswig-Holstein, Norderoog (Hallig)'),
       (4412, 1, 'Schleswig-Holstein, Süderoog (Hallig)'),
       (4413, 1, 'Schleswig-Holstein, Südfall (Hallig)'),
       (4414, 1, 'Schleswig-Holstein, Norderoogsand (Nordsee)'),
       (4415, 1, 'Schleswig-Holstein, Blauort (Meldorfer Bucht)'),
       (4416, 1, 'Schleswig-Holstein, Trischen (Meldorfer Bucht)'),
       (4417, 1, 'Hamburg, Neuwerk (Helgoländer Bucht)'),
       (4418, 1, 'Hamburg, Scharhörn und Nigehörn (Helgoländer Bucht)'),
       (4419, 1, 'Niedersachsen, Mellum (Nordsee)'),
       (4420, 1, 'Niedersachsen, Minsener Oog (Nordsee)'),
       (4421, 1, 'Niedersachsen, Wangerooge (Nordsee)'),
       (4422, 1, 'Niedersachsen, Spiekeroog (Nordsee)'),
       (4423, 1, 'Niedersachsen, Langeoog (Nordsee)'),
       (4424, 1, 'Niedersachsen, Baltrum (Nordsee)'),
       (4425, 1, 'Niedersachsen, Norderney (Nordsee)'),
       (4426, 1, 'Niedersachsen, Juist (Nordsee)'),
       (4427, 1, 'Niedersachsen, Memmert (Nordsee)'),
       (4428, 1, 'Niedersachsen, Kachelotplate (Nordsee)'),
       (4429, 1, 'Niedersachsen, Lütje Hörn (Nordsee)'),
       (4430, 1, 'Niedersachsen, Borkum (Nordsee)'),
       (4431, 1, 'Schleswig-Holstein, Helgoland (Nordsee)'),
       (4432, 1, 'Schleswig-Holstein, Helgoland-Düne (Nordsee)'),
       (4433, 1, 'Baden-Württemberg, Büsingen'),
       (4434, 1, 'Schaffhausen, Büsingen'),
       (4435, 1, 'Bayern, Jungholz'),
       (4436, 1, 'Tirol, Jungholz'),
       (4437, 1, 'Bayern, Mittelberg'),
       (4438, 1, 'Vorarlberg, Mittelberg'),
...
VALUES (4466, 1, 'Vardarski'),
       ...
       (4478, 1, 'RA'),
       (4479, 1, 'Rewa'),       
       (4480, 1, 'Chaharmahal and Bakhtiari'),
       (4481, 1, 'Isfahan'),
       (4482, 1, 'Kohgiluyeh and Boyer-Ahmad'),
       (4483, 1, 'Attapeu'),
       (4484, 1, 'Bolikhamsai'),
       (4485, 1, 'Houaphanh'),
       (4486, 1, 'Khammouane'),
       (4487, 1, 'Luang Namtha'),
       (4488, 1, 'Luang Prabang'),
       (4489, 1, 'Oudomxay'),
       (4490, 1, 'Phongsaly'),
       (4491, 1, 'Sainyabuli'),
       (4492, 1, 'Sekong'),
