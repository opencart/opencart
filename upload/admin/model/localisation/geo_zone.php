...
class GeoZone extends \Opencart\System\Engine\Model {
	public function addGeoZone(array $data) {
	...
	public function editGeoZone(int $geo_zone_id, array $data) {
	...
	public function deleteGeoZone(int $geo_zone_id) {
