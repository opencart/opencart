...
<table class="table table-striped table-bordered">
  ...
  <tr>
    ...
    <td id="capture_status"><?php if ($firstdata_order['capture_status'] == 1) { ?>
      ...
      <a class="button btn btn-primary" id="btn_capture"><?php echo $btn_capture; ?></a> <span class="btn btn-primary" id="img_loading_capture" style="display:none;"><i class="fa fa-cog fa-spin fa-lg"></i></span>
      <?php } ?>
      <?php } ?></td>
  </tr>
  <tr>
