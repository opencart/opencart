...
$_['text_cron_1']          = 'CRON Job\'s are scheduled tasks that are run periodically. To setup your servers to use cron job you can read the <a href="https://docs.opencart.com/developer-guide/cron-jobs" target="_blank" class="alert-link">opencart documentation</a> page.';
