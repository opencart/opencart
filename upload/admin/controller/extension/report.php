		...
		if ($results) {
			foreach ($results as $result) {
				...
				$data['extensions'][] = [
					...
					'install'    => $this->url->link('extension/report.install', 'extension=' . $extension . '&code=' . $code),
					'uninstall'  => $this->url->link('extension/report.uninstall', 'extension=' . $extension . '&code=' . $code),
					'installed'  => in_array($code, $installed),
					'edit'       => $this->url->link('extension/' . $extension . '/report/' . $code)
				];
			}
		}
