            ...
            <div class="col-sm-12">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <a data-toggle="tooltip" title="<?php echo $button_filter; ?>" class="btn btn-primary input-group-addon" onclick="$('#order-update-form').submit();"><i class="mi mi-plus-circle">add_circle</i> <?php echo $button_status; ?></a>
                </div>
              </div>
            </div>
          </div>
