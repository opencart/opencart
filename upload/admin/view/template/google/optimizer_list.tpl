  ...
  <table class="list">
    ...
    <tbody>
      ...
      <tr class="<?php echo $class; ?>">
        <td align="center"><?php if ($experiment['delete']) { ?>
          <input type="checkbox" name="delete[]" value="<?php echo $experiment['google_optimizer_id']; ?>" checked="checked" />
          <?php } else { ?>
          <input type="checkbox" name="delete[]" value="<?php echo $experiment['google_optimizer_id']; ?>" />
          <?php } ?></td>
        <td class="left"><?php echo $experiment['name']; ?></td>
        <td class="left"><?php echo $experiment['status']; ?></td>
        <td class="left"><?php echo $experiment['date_added']; ?></td>
        <td class="right"><?php foreach ($experiment['action'] as $action) { ?>
