  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-perpetual-payments" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn"><i class="fa fa-check-circle"></i></button>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-perpetual-payments" class="form-horizontal">
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            ...
            <span class="text-danger"><?php echo $error_auth_id; ?></span>
            <?php } ?>
          </div>
        </div>
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            ...
            <span class="text-danger"><?php echo $error_auth_pass; ?></span>
            <?php } ?>
          </div>
        </div>
