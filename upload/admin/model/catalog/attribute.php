...
class ModelCatalogAttribute extends Model {
	public function addAttribute($data) {
		$this->event->trigger('pre.attribute.add', $data);
		...
		$this->event->trigger('post.attribute.add', $attribute_id);

		return $attribute_id;
	}

	public function editAttribute($attribute_id, $data) {
		$this->event->trigger('pre.attribute.edit', $data);
		...
		$this->event->trigger('post.attribute.edit', $attribute_id);
	}

	public function deleteAttribute($attribute_id) {
		$this->event->trigger('pre.attribute.delete', $attribute_id);

		$this->db->query("DELETE FROM " . DB_PREFIX . "attribute WHERE attribute_id = '" . (int)$attribute_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "attribute_description WHERE attribute_id = '" . (int)$attribute_id . "'");

		$this->event->trigger('post.attribute.delete', $attribute_id);
	}
