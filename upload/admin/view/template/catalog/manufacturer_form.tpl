            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="text-left"><select name="manufacturer_layout[0][layout_id]" class="form-control">
                      <option value=""></option>
                      <?php foreach ($layouts as $layout) { ?>
                      <?php if (isset($manufacturer_layout[0]) && $manufacturer_layout[0]['layout_id'] == $layout['layout_id']) { ?>
                ...
                <tr>
                  ...
                  <td class="text-left"><select name="manufacturer_layout[<?php echo $store['store_id']; ?>][layout_id]" class="form-control">
                      <option value=""></option>
                      <?php foreach ($layouts as $layout) { ?>
                      <?php if (isset($manufacturer_layout[$store['store_id']]) && $manufacturer_layout[$store['store_id']]['layout_id'] == $layout['layout_id']) { ?>
                      <option value="<?php echo $layout['layout_id']; ?>" selected="selected"><?php echo $layout['name']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $layout['layout_id']; ?>"><?php echo $layout['name']; ?></option>
                      <?php } ?>
