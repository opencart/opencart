...
$_['text_register_account']          = 'By creating an account you will be able to shop faster, track orders, maintain a wish list, and earn loyalty rewards. Besides, it takes only a minute to create an account!';
...
$_['text_shipping_method']           = 'Please select the shipping method for this order.';
$_['text_payment_method']            = 'Please select the payment method for this order.';
$_['text_comments']                  = 'Addional comments about this order';
...
// Error
$_['error_warning']                  = 'There was a problem while trying to process your order! If the problem persists please try selecting a different payment method or <a href="%s">contact us</a>.';
