...
class Subscription extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('account/subscription', 'language=' . $this->config->get('config_language') . $url)
		];
		...
		foreach ($results as $result) {
			...
			if ($product_info) {
				...
				$data['subscriptions'][] = [
					...
					'view'            => $this->url->link('account/subscription.info', 'language=' . $this->config->get('config_language') . '&subscription_id=' . $result['subscription_id'])
				];
			}
		}
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $limit,
			'url'   => $this->url->link('account/subscription', 'language=' . $this->config->get('config_language') . '&page={page}')
		]);
	...
	public function info(): ?object {
		...
		if ($subscription_info) {
			...
			$data['breadcrumbs'][] = [
				'text' => $heading_title,
				'href' => $this->url->link('account/subscription.info', 'language=' . $this->config->get('config_language') . '&subscription_id=' . $this->request->get['subscription_id'] . $url)
			];
			...
			//$data['order'] = $this->url->link('account/order.info', 'language=' . $this->config->get('config_language') . '&order_id=' . $subscription_info['order_id']);
			$data['product'] = $this->url->link('product/product', 'language=' . $this->config->get('config_language') . '&product_id=' . $subscription_info['product_id']);
