      ...
      <div class="tab-content">
        <div class="tab-pane active" id="tab-general">
          <div class="form-group required">
            <label class="col-lg-3 control-label" for="input-url"><?php echo $entry_url; ?></label>
            <div class="col-lg-9">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label" for="input-ssl"><?php echo $entry_ssl; ?></label>
            <div class="col-lg-9">
        ...
        <div class="tab-pane" id="tab-option">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label"><?php echo $entry_customer_price; ?></label>
              <div class="col-lg-9">
                <label class="radio-inline">
        ...
        <div class="tab-pane" id="tab-image">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-9"><img src="<?php echo $icon; ?>" alt="" class="img-thumbnail" />
          ...
          <div class="form-group required">
            ...
            <div class="col-lg-9">
              <div class="row">
                <div class="col-lg-6"><input type="text" name="config_image_related_width" value="<?php echo $config_image_related_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-related-width" class="form-control" /></div>
          ...
          <div class="form-group required">
            ...
            <div class="col-lg-9">
              <div class="row">
                <div class="col-lg-6"><input type="text" name="config_image_compare_width" value="<?php echo $config_image_compare_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-compare-width" class="form-control" /></div>
          ...
          <div class="form-group required">
            ...
            <div class="col-lg-9">
              <div class="row">
                <div class="col-lg-6"><input type="text" name="config_image_wishlist_width" value="<?php echo $config_image_wishlist_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-wishlist-width" class="form-control" /></div>
          ...
          <div class="form-group required">
            ...
            <div class="col-lg-9">
              <div class="row">
                <div class="col-lg-6"><input type="text" name="config_image_cart_width" value="<?php echo $config_image_cart_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-cart-width" class="form-control" /></div>
