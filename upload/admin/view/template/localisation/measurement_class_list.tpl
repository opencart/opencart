  ...
  <table class="list">
    ...
    <tbody>
      ...
      <tr class="<?php echo $class; ?>">
        <td style="align: center;"><?php if ($measurement_class['delete']) { ?>
          <input type="checkbox" name="delete[]" value="<?php echo $measurement_class['measurement_class_id']; ?>" checked="checked" />
          <?php } else { ?>
          <input type="checkbox" name="delete[]" value="<?php echo $measurement_class['measurement_class_id']; ?>" />
          <?php } ?></td>
