  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-pp-login" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-check-circle"></i></button>
  ...
  <div class="container-fluid">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-pp-login" class="form-horizontal">
	  ...
	  <div class="form-group">
		<label class="col-sm-2 control-label" for="entry-sandbox"><?php echo $entry_sandbox; ?></label>
		<div class="col-sm-10">
		  ...
		  <span class="help-block"><?php echo $help_sandbox; ?></span></div>
	  </div>
	  <div class="form-group">
		<label class="col-sm-2 control-label" for="input-loggin"><?php echo $entry_logging; ?></label>
		<div class="col-sm-10">
		  <select name="pp_login_logging" id="input-logging" class="form-control">
			...
			<option value="0" selected="selected"><?php echo $text_no; ?></option>
			<?php } ?>
		  </select><span class="help-block"><?php echo $help_debug_logging; ?></span></div>
	  </div>
	  <div class="form-group">
		...
		<div class="col-sm-10">
		  <select name="pp_login_customer_group_id" id="input-customer-group" class="form-control">
			...
			<?php } ?>
			<?php } ?>
		  </select><span class="help-block"><?php echo $help_customer_group; ?></span></div>
	  </div>
	  <div class="form-group">
	  ...
	  <div class="form-group">
		<label class="col-sm-2 control-label" for="input-seamless"><?php echo $entry_seamless; ?></label>
		<div class="col-sm-10">
		  <select name="pp_login_seamless" id="input-logging" class="form-control">
			...
			<option value="0" selected="selected"><?php echo $text_no; ?></option>
			<?php } ?>
		  </select><span class="help-block"><?php echo $help_seamless; ?></span></div>
	  </div>
	  <?php foreach ($languages as $language) { ?>
	  <div class="form-group">
		<label class="col-sm-2 control-label" for="input-locale<?php echo $language['language_id']; ?>"><?php echo $language['entry_locale']; ?></label>
		<div class="col-sm-10">
		  <select name="pp_login_locale[<?php echo $language['language_id']; ?>]" id="input-locale<?php echo $language['language_id']; ?>" class="form-control">
			<?php foreach ($pp_login_locale_all as $locale => $pp_login_locale) { ?>
			<?php if (isset($pp_login_locale_saved[$language['language_id']]) && $pp_login_locale_saved[$language['language_id']] == $locale) { ?>
			<option value="<?php echo $locale; ?>" selected="selected"><?php echo $pp_login_locale; ?></option>
			<?php } else { ?>
			<option value="<?php echo $locale; ?>"><?php echo $pp_login_locale; ?></option>
			<?php } ?>
			<?php } ?>
