...
$_['text_preferred_main']		 	 = 'Easily accept credit and debit cards and PayPal on multiple devices with no setup or monthly fees. Click the button below to connect your account';
$_['text_preferred_li_1']			 = 'Accept credit cards and PayPal with one click from around the world';
$_['text_preferred_li_2']			 = 'Improve conversion with PayPal One Touch';
$_['text_preferred_li_3']			 = 'Achieve PCI DSS v3.0 SAQ-A compliance using Hosted Fields';
$_['text_preferred_li_4']			 = 'Use PayPal in-context checkout so a user never has to leave your site';
