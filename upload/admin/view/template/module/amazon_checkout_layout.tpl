  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-cba-layout" class="btn btn-primary"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
        <a href="<?php echo $cancel; ?>" class="btn btn-danger"><i class="fa fa-times"></i> <?php echo $button_cancel; ?></a></div>
      <h1 class="panel-title"><i class="fa fa-pencil-square"></i> <?php echo $heading_title; ?></h1>
    </div>
    <div class="panel-body">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-cba-layout">
        <table id="module" class="table table-striped table-bordered table-hover">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              <td class="text-left">
                <select name="amazon_checkout_layout_module[<?php echo $module_row; ?>][layout_id]" class="form-control">
              ...
              <td class="text-left">
                <select name="amazon_checkout_layout_module[<?php echo $module_row; ?>][position]" class="form-control">
              ...
              <td class="text-left">
                <select name="amazon_checkout_layout_module[<?php echo $module_row; ?>][status]" class="form-control">
...
function addModule() {	
	...
	html += '  <tr>';
	html += '    <td class="left"><select name="amazon_checkout_layout_module[' + module_row + '][layout_id]" class="form-control">';
	<?php foreach ($layouts as $layout) { ?>
	html += '      <option value="<?php echo $layout['layout_id']; ?>"><?php echo addslashes($layout['name']); ?></option>';
	<?php } ?>
	html += '    </select></td>';
	html += '    <td class="left"><select name="amazon_checkout_layout_module[' + module_row + '][position]" class="form-control">';
	html += '      <option value="content_top"><?php echo $text_content_top; ?></option>';
	html += '      <option value="content_bottom"><?php echo $text_content_bottom; ?></option>';
	html += '      <option value="column_left"><?php echo $text_column_left; ?></option>';
	html += '      <option value="column_right"><?php echo $text_column_right; ?></option>';
	html += '    </select></td>';
	html += '    <td class="left"><select name="amazon_checkout_layout_module[' + module_row + '][status]" class="form-control">';
