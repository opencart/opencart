...
class ModelSettingExtension extends Model {	
	...
	public function getExtensionInstallByFilename($filename) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "extension_install` WHERE `filename` = '" . $this->db->escape($filename) . "'");
