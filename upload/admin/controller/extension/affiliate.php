...
class ControllerExtensionAffiliate extends Controller {
	public function index() {
		...
		$this->document->title = $this->language->get('heading_title'); 
  		...
  		$this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => HTTPS_SERVER . 'index.php?route=extension/affiliate',
			...
			foreach ($files as $file) {
				...
				if (!in_array($extension, $extensions)) {
					$action[] = array(
						...
						'href' => HTTPS_SERVER . 'index.php?route=extension/affiliate/install&extension=' . $extension
					);
				} else {
					$action[] = array(
						'text' => $this->language->get('text_edit'),
						'href' => HTTPS_SERVER . 'index.php?route=affiliate/' . $extension
					);
								
					$action[] = array(
						'text' => $this->language->get('text_uninstall'),
						'href' => HTTPS_SERVER . 'index.php?route=extension/affiliate/uninstall&extension=' . $extension
					);
				}
	...
	public function install() {
		if (!$this->user->hasPermission('modify', 'extension/affiliate')) {
			...
			$this->redirect(HTTPS_SERVER . 'index.php?route=extension/affiliate');
		} else {
			$this->load->model('setting/extension');
