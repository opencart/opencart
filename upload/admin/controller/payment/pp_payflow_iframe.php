...
class ControllerPaymentPPPayflowIframe extends Controller {
	...
	public function index() {
		...
		$data['cancel_url'] = HTTPS_CATALOG . 'index.php?route=payment/pp_payflow_iframe/payment_cancel';
		$data['error_url'] = HTTPS_CATALOG . 'index.php?route=payment/pp_payflow_iframe/payment_error';
		$data['return_url'] = HTTPS_CATALOG . 'index.php?route=payment/pp_payflow_iframe/payment_return';
		$data['post_url'] = HTTPS_CATALOG . 'index.php?route=payment/pp_payflow_iframe/payment_ipn';
