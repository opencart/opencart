  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" id="button-save" form="form-setting" data-toggle="tooltip" title="<?php echo $button_save; ?>" disabled="disabled" class="btn btn-primary"><i class="mi mi-save">save</i></button>
...
$('select[name=\'config_theme\']').on('change', function() {
	$.ajax({
		...
		dataType: 'html',
		beforeSend: function() {
			$('select[name=\'config_theme\']').after(' <i class="mi mi-circle-o-notch mi-spin">refresh</i>');
		},
		complete: function() {
			$('.mi-spin').remove();
		},
...
$('select[name=\'config_country_id\']').on('change', function() {
	$.ajax({
		...
		dataType: 'json',
		beforeSend: function() {
			$('select[name=\'config_country_id\']').after(' <i class="mi mi-circle-o-notch mi-spin">refresh</i>');
		},
		complete: function() {
			$('.mi-spin').remove();
		},
