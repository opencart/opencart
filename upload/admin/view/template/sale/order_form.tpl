  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-order" class="btn btn-primary"><i class="fa-ok"></i> <?php echo $button_save; ?></button>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="tab-product">
              ...
              <table class="table table-striped table-bordered table-hover">
                ...
                <tbody id="product">
                  ...
                  <tr id="product-row<?php echo $product_row; ?>">
                    <td class="text-center" style="width: 3px;"><button type="button" onclick="$('#product-row<?php echo $product_row; ?>').remove(); $('#button-update').trigger('click');" class="btn btn-danger btn-sm"><i class="fa-minus-sign"></i></button></td>
            ...
            <div class="text-right">
              <button type="button" id="button-product" class="btn btn-primary"><i class="fa-plus-sign"></i> <?php echo $button_product_add; ?></button>
            </div>
          </div>
          <div class="tab-pane" id="tab-voucher">
              ...
              <table class="table table-striped table-bordered table-hover">
                ...
                <tbody id="voucher">
                  ...
                  <tr id="voucher-row<?php echo $voucher_row; ?>">
                    <td class="text-center" style="width: 3px;"><button type="button" onclick="$('#voucher-row<?php echo $voucher_row; ?>').remove(); $('#button-update').trigger('click');" class="btn btn-danger btn-sm"><i class="fa-minus-sign"></i></button></td>
            ...
            <div class="text-right">
              <button type="button" id="button-voucher" class="btn btn-primary"><i class="fa-plus-sign"></i> <?php echo $button_voucher_add; ?></button>
            </div>
          </div>
          <div class="tab-pane" id="tab-total">
            ...
            <div class="text-right">
              <button type="button" id="button-update" class="btn btn-primary"><i class="fa-plus-sign"></i> <?php echo $button_total; ?></button>
            </div>
          </div>
        </div>
      </form>
		...
		if (item['option'] != '') {
			...
			for (i = 0; i < item['option'].length; i++) {
				...
				if (option['type'] == 'file') {
					...
					html += '  <label class="col-sm-2 control-label">' + option['name'] + '</label>';
					html += '  <div class="col-sm-10">';
					html += '    <button type="button" id="button-upload' + option['product_option_id'] + '" class="btn btn-default"><i class="fa-upload"></i> <?php echo $button_upload; ?></button>';
...
$('#button-product, #button-voucher, #button-update').on('click', function() {	
	...
	$.ajax({
		...
		complete: function() {
			$('#button-product i, #button-voucher i, #button-update i').replaceWith('<i class="fa-plus-sign"></i>');
		...
		success: function(json) {
			...
			if (json['error']) {
				if (json['error']['warning']) {
					$('.panel').before('<div class="alert alert-danger"><i class="fa-exclamation-sign"></i> ' + json['error']['warning'] + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
				}
				...
				if (json['error']['product']) {
					...
					if (json['error']['product']['stock']) {
						$('.panel').before('<div class="alert alert-danger"><i class="fa-exclamation-sign"></i> ' + json['error']['product']['stock'] + '</div>');
					}	
					
					if (json['error']['product']['store']) {
						$('.panel').before('<div class="alert alert-danger"><i class="fa-exclamation-sign"></i> ' + json['error']['product']['store'] + '</div>');
					}	
																
					if (json['error']['product']['minimum']) {	
						for (i in json['error']['product']['minimum']) {
							$('.panel').before('<div class="alert alert-danger"><i class="fa-exclamation-sign"></i> ' + json['error']['product']['minimum'][i] + '</div>');
						}						
					}
				} else {
				...
				if (json['error']['shipping_method']) {
					$('.panel').before('<div class="alert alert-danger"><i class="fa-exclamation-sign"></i> ' + json['error']['shipping_method'] + '</div>');
				}	
				
				// Payment Method
				if (json['error']['payment_method']) {
					$('.panel').before('<div class="alert alert-danger"><i class="fa-exclamation-sign"></i> ' + json['error']['payment_method'] + '</div>');
				}	
															
				// Coupon
				if (json['error']['coupon']) {
					$('.panel').before('<div class="alert alert-danger"><i class="fa-exclamation-sign"></i> ' + json['error']['coupon'] + '</div>');
				}
				
				// Voucher
				if (json['error']['voucher']) {
					$('.panel').before('<div class="alert alert-danger"><i class="fa-exclamation-sign"></i> ' + json['error']['voucher'] + '</div>');
				}
				
				// Reward Points		
				if (json['error']['reward']) {
					$('.panel').before('<div class="alert alert-danger"><i class="fa-exclamation-sign"></i> ' + json['error']['reward'] + '</div>');
				}	
			} else {
				$('input[name=\'product\']').val('');
				$('input[name=\'product_id\']').val('');
			...
			if (json['order_product'] != '') {
				...
				for (i = 0; i < json['order_product'].length; i++) {
					...
					html += '  <td class="text-center" style="width: 3px;"><button type="button" onclick="$(\'#product-row' + product_row + '\').remove(); $(\'#button-update\').trigger(\'click\');" class="btn btn-danger btn-sm"><i class="fa-minus-sign"></i></button></td>';
			...
			if (json['order_voucher'] != '') {
				var voucher_row = 0;
				 ...
				 for (i in json['order_voucher']) {
					...
					html += '  <td class="text-center" style="width: 3px;"><button type="button" onclick="$(\'#voucher-row' + voucher_row + '\').remove(); $(\'#button-update\').trigger(\'click\');" class="btn btn-danger btn-sm"><i class="fa-minus-sign"></i></button></td>';
