      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset id="address">
          ...
          <div class="form-group" style="display:none">
            ...
            <div class="col-sm-10">
              <input type="text" name="address_1" value="defaultaddress_1" placeholder="<?php echo $entry_address_1; ?>" id="input-address-1" class="form-control" />
          ...
          <div class="form-group required" style="display:none">
            ...
            <div class="col-sm-10">
              <input type="text" name="city" value="defaultCity" placeholder="<?php echo $entry_city; ?>" id="input-city" class="form-control" />
              <?php if ($error_city) { ?>
          ...
          <div class="form-group required" style="display:none">
            ...
            <div class="col-sm-10">
              <input type="text" name="postcode" value="defaultpostcode" placeholder="<?php echo $entry_postcode; ?>" id="input-postcode" class="form-control" />
