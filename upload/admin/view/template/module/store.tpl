        ...
        <table id="module" class="table">
          ...
          <tbody>
            ...
            <tr id="module-row<?php echo $module_row; ?>">
              ...
              <td class="right"><input type="text" name="store_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" class="input-mini" /></td>
...
function addModule() {	
    ...
    html += '  </select></td>';
	html += '  <td class="right"><input type="text" name="store_module[' + module_row + '][sort_order]" value="" class="input-mini" /></td>';
