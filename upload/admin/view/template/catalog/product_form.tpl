  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-product" class="btn btn-primary"><i class="fa-ok"></i> <?php echo $button_save; ?></button>
          ...
          <div class="tab-pane" id="tab-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10"><img src="<?php echo $thumb; ?>" alt="" class="img-thumbnail" />
                ...
                <br />
                <div class="btn-group">
                  <button type="button" data-toggle="modal" data-target="#modal" class="btn btn-default"><span class="fa-pencil"></span> <?php echo $button_edit; ?></button>
                  <button type="button" onclick="$(this).parent().parent().find('img').attr('src', '<?php echo $no_image; ?>'); $(this).parent().parent().find('input').attr('value', '');" class="btn btn-danger"><span class="fa-trash"></span> <?php echo $button_clear; ?></button>
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <div id="product-category" class="well">
                  ...
                  <div id="product-category<?php echo $product_category['category_id']; ?>"><i class="fa-minus-sign"></i> <?php echo $product_category['name']; ?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <div id="product-filter" class="well">
                  ...
                  <div id="product-filter<?php echo $product_filter['filter_id']; ?>"><i class="fa-minus-sign"></i> <?php echo $product_filter['name']; ?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <div id="product-download" class="well">
                  ...
                  <div id="product-download<?php echo $product_download['download_id']; ?>"><i class="fa-minus-sign"></i> <?php echo $product_download['name']; ?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                ...
                <div id="product-related" class="well">
                  ...
                  <div id="product-related<?php echo $product_related['product_id']; ?>"><i class="fa-minus-sign"></i> <?php echo $product_related['name']; ?>
            ...
            <div class="table-responsive">
              <table id="attribute" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr id="attribute-row<?php echo $attribute_row; ?>">
                    ...
                    <td class="text-left"><?php foreach ($languages as $language) { ?>
                      ...
                      <?php } ?></td>
                    <td class="text-left"><button type="button" onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();" class="btn btn-danger"><i class="fa-minus-sign"></i> <?php echo $button_remove; ?></button></td>
                  </tr>
                  <?php $attribute_row++; ?>
                  <?php } ?>
                </tbody>
                <tfoot>
                  <tr>
                    <td colspan="2"></td>
                    <td class="text-left"><button type="button" onclick="addAttribute();" class="btn btn-primary"><i class="fa-plus-sign"></i> <?php echo $button_attribute_add; ?></button></td>
                  </tr>
                </tfoot>
              </table>
            </div>
            ...
            <div class="row">
              <div class="col-sm-2">
                <ul class="nav nav-pills nav-stacked" id="option">
                  ...
                  <li><a href="#tab-option<?php echo $option_row; ?>" data-toggle="tab"><i class="fa-minus-sign" onclick="$('a[href=\'#tab-option<?php echo $option_row; ?>\']').parent().remove(); $('#tab-option<?php echo $option_row; ?>').remove(); $('#option a:first').tab('show');"></i> <?php echo $product_option['name']; ?></a></li>
                  <?php $option_row++; ?>
                  <?php } ?>
                  <li>
                      ...
                      <table id="option-value<?php echo $option_row; ?>" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                          ...
                          <tr id="option-value-row<?php echo $option_value_row; ?>">
                            ...
                            <td class="text-left"><button type="button" onclick="$('#option-value-row<?php echo $option_value_row; ?>').remove();" class="btn btn-danger"><i class="fa-minus-sign"></i> <?php echo $button_remove; ?></button></td>
                          </tr>
                        ...
                        <tfoot>
                          <tr>
                            <td colspan="6"></td>
                            <td class="text-left"><button type="button" onclick="addOptionValue('<?php echo $option_row; ?>');" class="btn btn-primary"><i class="fa-plus-sign"></i> <?php echo $button_option_value_add; ?></button></td>
                          </tr>
                        </tfoot>
                      </table>
                    </div>
              ...
              <table id="discount" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr id="discount-row<?php echo $discount_row; ?>">
                    ...
                    <td class="text-left"><button type="button" onclick="$('#discount-row<?php echo $discount_row; ?>').remove();" class="btn btn-danger"><i class="fa-minus-sign"></i> <?php echo $button_remove; ?></button></td>
                  </tr>
                  <?php $discount_row++; ?>
                  <?php } ?>
                </tbody>
                <tfoot>
                  <tr>
                    <td colspan="6"></td>
                    <td class="text-left"><button type="button" onclick="addDiscount();" class="btn btn-primary"><i class="fa-plus-sign"></i> <?php echo $button_discount_add; ?></button></td>
                  </tr>
                </tfoot>
              </table>
            </div>
              ...
              <table id="special" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr id="special-row<?php echo $special_row; ?>">
                    ...
                    <td class="text-left"><button type="button" onclick="$('#special-row<?php echo $special_row; ?>').remove();" class="btn btn-danger"><i class="fa-minus-sign"></i> <?php echo $button_remove; ?></button></td>
                  </tr>
                  <?php $special_row++; ?>
                  <?php } ?>
                </tbody>
                <tfoot>
                  <tr>
                    <td colspan="5"></td>
                    <td class="text-left"><button type="button" onclick="addSpecial();" class="btn btn-primary"><i class="fa-plus-sign"></i> <?php echo $button_special_add; ?></button></td>
                  </tr>
                </tfoot>
              </table>
            </div>
            ...
            <div class="table-responsive">
              <table id="images" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    ...
                    <td class="text-left"><div class="btn-group">
                        <button type="button" data-toggle="modal" data-target="#modal" class="btn btn-default"><span class="fa-pencil"></span> <?php echo $button_edit; ?></button>
                        <button type="button" onclick="$('image-row<?php echo $image_row; ?> img').find('img').attr('src', '<?php echo $no_image; ?>'); $('image-row<?php echo $image_row; ?>').parent().parent().find('input').attr('value', '');" class="btn btn-danger"><span class="fa-trash"></span> <?php echo $button_clear; ?></button>
                      </div></td>
                    <td class="text-right"><input type="text" name="product_image[<?php echo $image_row; ?>][sort_order]" value="<?php echo $product_image['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>
                    <td class="text-left"><button type="button" onclick="$('#image-row<?php echo $image_row; ?>').remove();" class="btn btn-danger"><i class="fa-minus-sign"></i> <?php echo $button_remove; ?></button></td>
                  </tr>
                  <?php $image_row++; ?>
                  <?php } ?>
                </tbody>
                <tfoot>
                  <tr>
                    <td colspan="3"></td>
                    <td class="text-left"><button type="button" onclick="addImage();" class="btn btn-primary"><i class="fa-plus-sign"></i> <?php echo $button_image_add; ?></button></td>
                  </tr>
                </tfoot>
              </table>
            </div>
...
$('input[name=\'category\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#product-category').append('<div id="product-category' + item['value'] + '"><i class="fa-minus-sign"></i> ' + item['label'] + '<input type="hidden" name="product_category[]" value="' + item['value'] + '" /></div>');	
	}
});
...
$('input[name=\'filter\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#product-filter').append('<div id="product-filter' + item['value'] + '"><i class="fa-minus-sign"></i> ' + item['label'] + '<input type="hidden" name="product_filter[]" value="' + item['value'] + '" /></div>');	
	}	
});
...
$('input[name=\'download\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#product-download').append('<div id="product-download' + item['value'] + '"><i class="fa-minus-sign"></i> ' + item['label'] + '<input type="hidden" name="product_download[]" value="' + item['value'] + '" /></div>');	
	}	
});
...
$('input[name=\'related\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#product-related').append('<div id="product-related' + item['value'] + '"><i class="fa-minus-sign"></i> ' + item['label'] + '<input type="hidden" name="product_related[]" value="' + item['value'] + '" /></div>');	
	}	
});
...
function addAttribute() {
    ...
    <?php } ?>
	html += '  </td>';
	html += '  <td class="text-left"><button type="button" onclick="$(\'#attribute-row' + attribute_row + '\').remove();" class="btn btn-danger"><i class="fa-minus-sign"></i> <?php echo $button_remove; ?></button></td>';
    html += '</tr>';
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
			...
			html += '        <td class="text-left"><button type="button" onclick="addOptionValue(' + option_row + ');" class="btn btn-primary"><i class="fa-plus-sign"></i> <?php echo $button_option_value_add; ?></button></td>';
			html += '      </tr>';
			html += '    </tfoot>';
			html += '  </table>';
			html += '</div>';
		...
		$('#option > li:last-child').before('<li><a href="#tab-option' + option_row + '" data-toggle="tab"><i class="fa-minus-sign" onclick="$(\'a[href=\\\'#tab-option' + option_row + '\\\']\').parent().remove(); $(\'#tab-option' + option_row + '\').remove(); $(\'#option a:first\').tab(\'show\')"></i> ' + item['label'] + '</li>');
...
function addOptionValue(option_row) {	
	...
	html += '  <td class="text-left"><button type="button" onclick="$(\'#option-value-row' + option_value_row + '\').remove();" class="btn btn-danger"><i class="fa-minus-sign"></i> <?php echo $button_remove; ?></button></td>';
	html += '</tr>';
...
function addDiscount() {
	...
	html += '  <td class="text-left"><button type="button" onclick="$(\'#discount-row' + discount_row + '\').remove();" class="btn btn-danger"><i class="fa-minus-sign"></i> <?php echo $button_remove; ?></button></td>';
	html += '</tr>';	
...
function addSpecial() {
	...
	html += '  <td class="text-left"><button type="button" onclick="$(\'#special-row' + special_row + '\').remove();" class="btn btn-danger"><i class="fa-minus-sign"></i> <?php echo $button_remove; ?></button></td>';
	html += '</tr>';
...
function addImage() {
	...
	html += '  <td class="text-left"><div class="btn-group"><button type="button" data-toggle="modal" data-target="#modal" class="btn btn-default"><span class="fa-pencil"></span> <?php echo $button_edit; ?></button><button type="button" onclick="$(this).parent().parent().find(\'img\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(this).parent().parent().find(\'input\').attr(\'value\', \'\');" class="btn btn-danger"><span class="fa-trash"></span> <?php echo $button_clear; ?></button></div></td>';
	html += '  <td class="text-right"><input type="text" name="product_image[' + image_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
	html += '  <td class="text-left"><button type="button" onclick="$(\'#image-row' + image_row  + '\').remove();" class="btn btn-danger"><i class="fa-minus-sign"></i> <?php echo $button_remove; ?></button></td>';
	html += '</tr>';
