...
class UserPermission extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['add'] = $this->url->link('user/user_permission.form', $url);
		$data['delete'] = $this->url->link('user/user_permission.delete');
	...
	protected function getList(): string {
		...
		$data['action'] = $this->url->link('user/user_permission.list', $url);
		...
		foreach ($results as $result) {
			$data['user_groups'][] = [
				...
				'name'          => $result['name'],
				'edit'          => $this->url->link('user/user_permission.form', 'user_group_id=' . $result['user_group_id'] . $url)
			];
		}
		...
		$data['sort_name'] = $this->url->link('user/user_permission.list', 'sort=name' . $url);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('user/user_permission.list', $url . '&page={page}')
		]);
	...
	public function form(): void {
		...
		$data['save'] = $this->url->link('user/user_permission.save');
		$data['back'] = $this->url->link('user/user_permission', $url);
