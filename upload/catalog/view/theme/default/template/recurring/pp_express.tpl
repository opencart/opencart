<div class="buttons clearfix">
  ...
  <div class="pull-left">
    <button type="button" id="button-cancel" class="btn btn-danger"><?php echo $button_cancel; ?></button>
  </div>
  <?php } ?>
...
$(document).delegate('#button-cancel', 'click', function() { 
    $.ajax({
        ...
        success: function(json) {
			...
			if (json['error']) {
				$('#button-cancel').prepend('<div class="alert alert-danger">' + json['error'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
			}
        },
