...
class ModelMarketingMarketing extends Model {
	public function addMarketing($data) {
		$this->event->trigger('pre.marketing.add', $data);
		...
		$this->event->trigger('post.marketing.add', $marketing_id);

		return $marketing_id;
	}

	public function editMarketing($marketing_id, $data) {
		$this->event->trigger('pre.marketing.edit', $data);
		...
		$this->event->trigger('post.marketing.edit', $marketing_id);
	}

	public function deleteMarketing($marketing_id) {
		$this->event->trigger('pre.marketing.delete', $marketing_id);

		$this->db->query("DELETE FROM " . DB_PREFIX . "marketing WHERE marketing_id = '" . (int)$marketing_id . "'");

		$this->event->trigger('post.marketing.delete', $marketing_id);
	}
