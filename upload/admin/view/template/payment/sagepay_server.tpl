			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="pull-right">
						<button type="submit" form="form-sagepay-server" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn"><i class="fa fa-check-circle"></i></button>
				...
				<div class="panel-body">
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sagepay-server" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<span id="cron-job-url"><?php echo $sagepay_server_cron_job_url ?></span>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<span><?php echo $sagepay_server_last_cron_job_run ?></span>
							</div>
						</div>
					</form>
				</div>
