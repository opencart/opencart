...
class CustomerActivity extends \Opencart\System\Engine\Controller {
	...
	public function getReport(): string {
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($activity_total) ? (($page - 1) * $this->config->get('config_pagination_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_pagination_admin')) > ($activity_total - $this->config->get('config_pagination_admin'))) ? $activity_total : ((($page - 1) * $this->config->get('config_pagination_admin')) + $this->config->get('config_pagination_admin')), $activity_total, ceil($activity_total / $this->config->get('config_pagination_admin')));
