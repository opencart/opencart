    ...
    <div class="box">
        ...
        <div class="content">
            <div id="tabs" class="htabs">
                ...
                <a href="#tab-template"><?php echo $text_tab_template; ?></a>
                <a href="#tab-gallery"><?php echo $text_tab_gallery; ?></a>
            </div>
            <form action="<?php echo $btn_save; ?>" method="post" enctype="multipart/form-data" id="form">
                ...
                <div id="tab-template">
                    <table class="form">
                        <tr>
                            <td><label><?php echo $text_template_choose; ?></td>
                            <td>
                ...
                <div id="tab-gallery">
                    <table class="form">
                        <tr>
                            <td><label><?php echo $text_image_gallery; ?></td>
                            <td>
                        ...
                        <tr>
                            <td><label><?php echo $text_image_thumb; ?></td>
                            <td>
                        ...
                        <tr>
                            <td><?php echo $text_image_super; ?></td>
                            <td>
                        ...
                        <tr>
                            <td><?php echo $text_image_gallery_plus; ?></td>
                            <td>
                        ...
                        <tr>
                            <td><?php echo $text_image_all_ebay; ?></td>
                            <td>
                        ...
                        <tr>
                            <td><?php echo $text_image_all_template; ?></td>
                            <td>
                        ...
                        <tr>
                            <td><?php echo $text_image_exclude_default; ?></td>
                            <td>
