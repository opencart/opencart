...
class Antispam extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('cms/antispam', $url)
		];

		$data['add'] = $this->url->link('cms/antispam.form', $url);
		$data['delete'] = $this->url->link('cms/antispam.delete');
	...
	protected function getList(): string {
		...
		$data['action'] = $this->url->link('cms/antispam.list', $url);
		...
		foreach ($results as $result) {
			$data['antispams'][] = [
				...
				'edit'        => $this->url->link('cms/antispam.form', 'antispam_id=' . $result['antispam_id'] . $url)
			];
		}
		...
		$data['sort_keyword'] = $this->url->link('cms/antispam.list', 'sort=keyword' . $url);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('cms/antispam.list', $url . '&page={page}')
		]);
	...
	public function form(): void {
		...
		$data['save'] = $this->url->link('cms/antispam.save');
		$data['back'] = $this->url->link('cms/antispam', $url);
