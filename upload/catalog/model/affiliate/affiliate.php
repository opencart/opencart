...
class ModelAffiliateAffiliate extends Model {
	public function addAffiliate($data) {
		$this->event->trigger('pre_affiliate_add');
		...
		$this->event->trigger('affiliate_add', array('affiliate_id' => $affiliate_id));

		return $affiliate_id;
	}

	public function editAffiliate($data) {
		$this->event->trigger('pre_affiliate_edit');
	...
	public function editPayment($data) {
		$this->event->trigger('pre_affiliate_edit_payment');
	...
	public function addTransaction($affiliate_id, $amount = '', $order_id = 0) {
		...
		if ($affiliate_info) {
			...
			$this->event->trigger('affiliate_add_transaction', array('affiliate_transaction_id' => $this->db->getLastId()));
		}
	}
