...
class ModelCatalogProductVariant extends Model {
	...
	public function editProductVariant($product_option_id, $data) {
	...
	public function deleteProductVariant($product_option_id) {
	...
	public function getProductVariant($product_option_id) {
	...
	public function getProductVariants($data = array()) {
	...
	public function getTotalProductVariants($data = array()) {
