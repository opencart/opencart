...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$this->url->link('extension/analytics', 'token=' . $this->session->data['token'], true);
		...
		$data['text_log'] = $this->language->get('text_og');
		...
		$data['log'] = $this->url->link('tool/log', 'token=' . $this->session->data['token'], true);
	...
	private function addMenu($text, $link, $children = array(), $id = '', $icon = '') {
		$menu = array();
