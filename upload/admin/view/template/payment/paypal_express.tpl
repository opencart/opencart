  ...
  <div id="tab_general" class="page">
    <table class="form">
      <tr>
        ...
        <td><input type="text" name="paypal_express_username" value="<?php echo $paypal_express_username; ?>" />
          <br />
      ...
      <tr>
        ...
        <td><input type="text" name="paypal_express_password" value="<?php echo $paypal_express_password; ?>" />
          <br />
      ...
      <tr>
        ...
        <td><input type="text" name="paypal_express_signature" value="<?php echo $paypal_express_signature; ?>" />
          <br />
      ...
      <tr>
        ...
        <td><?php if ($paypal_express_test) { ?>
          <input type="radio" name="paypal_express_test" value="1" checked="checked" />
          <?php echo $text_yes; ?>
          <input type="radio" name="paypal_express_test" value="0" />
          <?php echo $text_no; ?>
          <?php } else { ?>
          <input type="radio" name="paypal_express_test" value="1" />
          <?php echo $text_yes; ?>
          <input type="radio" name="paypal_express_test" value="0" checked="checked" />
          <?php echo $text_no; ?>
          <?php } ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><select name="paypal_express_order_status_id">
            ...
            <?php if ($order_status['order_status_id'] == $paypal_express_order_status_id) { ?>
      ...
      <tr>
        ...
        <td><select name="paypal_express_geo_zone_id">
            ...
            <?php if ($geo_zone['geo_zone_id'] == $paypal_express_geo_zone_id) { ?>
