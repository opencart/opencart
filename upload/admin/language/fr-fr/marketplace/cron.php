...
$_['text_cron_1']          = 'Les tâches cron sont des tâches planifiées qui s\'exécutent périodiquement. Pour configurer votre serveur pour utiliser des tâches cron, vous pouvez consulter la page de <a href="https://docs.opencart.com/developer-guide/cron-jobs" target="_blank" class="alert-link">documentation OpenCart</a>.';
