...
class ModelAffiliateAffiliate extends Model {
	...
	public function editAffiliate($data) {
		...
		$this->event->trigger('post.affiliate.edit', $this->affiliate->getId());
	}
	...
	public function editPayment($data) {
		...
		$this->event->trigger('post.affiliate.edit.payment', $this->affiliate->getId());
	}

	public function editPassword($email, $password) {
		$this->event->trigger('pre.affiliate.edit.password', $this->affiliate->getId());
		...
		$this->event->trigger('post.affiliate.edit.password', $this->affiliate->getId());
	}
