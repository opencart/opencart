      ...
      <div class="tab-content">
        <div class="tab-pane active" id="tab-account">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="firstdata_merchant_id" value="<?php echo $firstdata_merchant_id; ?>" placeholder="<?php echo $entry_merchant_id; ?>" id="input-merchant-id" class="form-control"/><?php if ($error_merchant_id) { ?>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="password" name="firstdata_secret" value="<?php echo $firstdata_secret; ?>" placeholder="<?php echo $entry_secret; ?>" id="input-secret" class="form-control"/><?php if ($error_secret) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="firstdata_geo_zone_id" id="input-geo-zone" class="form-control">
                ...
                <?php foreach ($geo_zones as $geo_zone) { ?><?php if ($geo_zone['geo_zone_id'] == $firstdata_geo_zone_id) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="firstdata_order_status_success_settled_id" id="input-order-status-success-settled" class="form-control">
                <?php foreach ($order_statuses as $order_status) { ?><?php if ($order_status['order_status_id'] == $firstdata_order_status_success_settled_id) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="firstdata_order_status_success_unsettled_id" id="input-order-status-success-unsettled" class="form-control">
                <?php foreach ($order_statuses as $order_status) { ?><?php if ($order_status['order_status_id'] == $firstdata_order_status_success_unsettled_id) { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                <?php } ?><?php } ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="firstdata_order_status_decline_id" id="input-order-status-decline" class="form-control">
                <?php foreach ($order_statuses as $order_status) { ?><?php if ($order_status['order_status_id'] == $firstdata_order_status_decline_id) { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                <?php } ?><?php } ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="firstdata_order_status_void_id" id="input-order-status-void" class="form-control">
                <?php foreach ($order_statuses as $order_status) { ?><?php if ($order_status['order_status_id'] == $firstdata_order_status_void_id) { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                <?php } else { ?>
                <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                <?php } ?><?php } ?>
        ...
        <div class="tab-pane" id="tab-advanced">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="firstdata_live_url" value="<?php echo $firstdata_live_url; ?>" placeholder="<?php echo $entry_live_url; ?>" id="input-live-url" class="form-control"/><?php if ($error_live_url) { ?>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="firstdata_demo_url" value="<?php echo $firstdata_demo_url; ?>" placeholder="<?php echo $entry_demo_url; ?>" id="input-demo-url" class="form-control"/><?php if ($error_demo_url) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <span class="help-block"><?php echo $text_help_notification; ?></span>
            </div>
          </div>
        </div>
      </div>
