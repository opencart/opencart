...
class ProductViewed extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/opencart/report/product_viewed')
		];

		$data['save'] = $this->url->link('extension/opencart/report/product_viewed.save');
	...
	public function getReport(): string {
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'url'   => $this->url->link('extension/opencart/report/product_viewed.list', 'code=product_viewed&page={page}')
		]);
