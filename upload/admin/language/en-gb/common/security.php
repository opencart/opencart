...
// Error
$_['error_install']            = 'Warning: Install folder does not exist!';
$_['error_storage']            = 'Warning: Install folder still exists and should be moved for security reasons!';
$_['error_admin']              = 'Warning: Install folder still exists and should be renamed for security reasons!';
