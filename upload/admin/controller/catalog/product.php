...
class ControllerCatalogProduct extends Controller {
	...
	protected function validateForm() {
		...
		foreach ($this->request->post['product_description'] as $language_id => $value) {
			if ((utf8_strlen(trim($value['name'])) < 1) || (utf8_strlen(trim($value['name'])) > 255)) {
		...
		if ((utf8_strlen(trim($this->request->post['model'])) < 1) || (utf8_strlen(trim($this->request->post['model'])) > 64)) {
