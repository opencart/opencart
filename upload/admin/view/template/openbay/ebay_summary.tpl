    ...
    $.ajax({
      ...
      success: function(json) {
          ...
          if (json.data.summary.QuantityLimitRemaining != ''){
              ...
              limitHtml += '<p><?php echo $text_ebay_limit_t1; ?> <span class="bold underline">'+json.data.summary.QuantityLimitRemaining+'</span> <?php echo addslashes($text_ebay_limit_t2); ?> <span class="underline bold">'+json.data.summary.AmountLimitRemaining+'</span></p>';
