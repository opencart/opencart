...
$_['text_order_comment']   = 'Klarnas Invoice ID: %s\n%s/%s: %.4f';
...
$_['help_company_id']      = 'Please enter your Companys registration number';
...
$_['error_deu_toc']        = 'You must agree to Klarnas privacy policy (Datenschutz)';
?>
