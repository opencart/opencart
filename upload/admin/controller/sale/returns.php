...
class Returns extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('sale/returns', $url)
		];

		$data['add'] = $this->url->link('sale/returns.form', $url);
		$data['delete'] = $this->url->link('sale/returns.delete');
	...
	protected function getList(): string {
		...
		$data['action'] = $this->url->link('sale/returns.list', $url);
		...
		foreach ($results as $result) {
			$data['returns'][] = [
				...
				'edit'          => $this->url->link('sale/returns.form', 'return_id=' . $result['return_id'] . $url)
			];
		}
		...
		$data['sort_return_id'] = $this->url->link('sale/returns.list', 'sort=r.return_id' . $url);
		$data['sort_order_id'] = $this->url->link('sale/returns.list', 'sort=r.order_id' . $url);
		$data['sort_customer'] = $this->url->link('sale/returns.list', 'sort=customer' . $url);
		$data['sort_product'] = $this->url->link('sale/returns.list', 'sort=r.product' . $url);
		$data['sort_model'] = $this->url->link('sale/returns.list', 'sort=r.model' . $url);
		$data['sort_status'] = $this->url->link('sale/returns.list', 'sort=return_status' . $url);
		$data['sort_date_added'] = $this->url->link('sale/returns.list', 'sort=r.date_added' . $url);
		$data['sort_date_modified'] = $this->url->link('sale/returns.list', 'sort=r.date_modified' . $url);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('sale/returns.list', $url . '&page={page}')
		]);
	...
	public function form(): void {
		...
		$data['save'] = $this->url->link('sale/returns.save');
		$data['back'] = $this->url->link('sale/returns', $url);
	...
	public function getHistory(): string {
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $limit,
			'url'   => $this->url->link('sale/returns.history', 'return_id=' . $return_id . '&page={page}')
		]);
