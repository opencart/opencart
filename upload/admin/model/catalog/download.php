...
class ModelCatalogDownload extends Model {
	public function addDownload($data) {
		$this->event->trigger('pre.download.add', $data);
		...
		$this->event->trigger('post.download.add', $download_id);

		return $download_id;
	}

	public function editDownload($download_id, $data) {
		$this->event->trigger('pre.download.edit', $data);
		...
		$this->event->trigger('post.download.edit', $download_id);
	}

	public function deleteDownload($download_id) {
		$this->event->trigger('pre.download.delete', $download_id);

		$this->db->query("DELETE FROM " . DB_PREFIX . "download WHERE download_id = '" . (int)$download_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "download_description WHERE download_id = '" . (int)$download_id . "'");

		$this->event->trigger('post.download.delete', $download_id);
	}
