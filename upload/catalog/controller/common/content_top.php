	...
	public function index() {
		...
		foreach ($extensions as $extension) {
			...
			foreach ($modules as $module) {
				if ($this->config->get($extension['code'] . '_' . $module . '_layout_id') == $layout_id && $this->config->get($extension['code'] . '_' . $module . '_position') == 'content_top' && $this->config->get($extension['code'] . '_' . $module . '_status')) {
					$module_data[] = array(
						'code'       => $extension['code'],
						'module'     => $module,
