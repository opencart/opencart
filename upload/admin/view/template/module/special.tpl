          ...
          <table id="module" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr id="module-row<?php echo $module_row; ?>">
                ...
                <td class="text-left"><input type="text" name="special_module[<?php echo $module_row; ?>][limit]" value="<?php echo $special_module['limit']; ?>" placeholder="<?php echo $entry_limit; ?>" class="form-control" /></td>
                <td class="text-left"><input type="text" name="special_module[<?php echo $module_row; ?>][width]" value="<?php echo $special_module['width']; ?>" placeholder="<?php echo $entry_width; ?>" class="form-control" />
                  <input type="text" name="special_module[<?php echo $module_row; ?>][height]" value="<?php echo $special_module['height']; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
...
function addModule() {	
	...
	html += '  <td class="text-left"><input type="text" name="special_module[' + module_row + '][width]" value="200" placeholder="<?php echo $entry_width; ?>" class="form-control" /> <input type="text" name="special_module[' + module_row + '][height]" value="200" placeholder="<?php echo $entry_height; ?>" class="form-control" /></td>';
