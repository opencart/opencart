...
<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
  <div id="tab_general" class="page"><?php echo $entry_status; ?><br />
    ...
    <select name="ccavenue_geo_zone_id">
    ...
    <select name="ccavenue_order_status_id">
    ...
    <input type="text" name="ccavenue_key" value="<?php echo $ccavenue_key; ?>" />
    <br />
    <?php if ($error_key) { ?>
    ...
    <input type="text" name="ccavenue_merchant" value="<?php echo $ccavenue_merchant; ?>" />
    <br />
    ...
    <input type="text" name="ccavenue_sort_order" value="<?php echo $ccavenue_sort_order; ?>" size="1" />
  </div>
</form>
