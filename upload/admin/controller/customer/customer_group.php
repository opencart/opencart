...
class ControllerCustomerCustomerGroup extends Controller {
	...
	private function getList() {
		...
		$results = $this->model_customer_customer_group->getCustomerGroups($data);
	...
	private function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $customer_group_id) {
			...
			$customer_total = $this->model_customer_customer->getTotalCustomersByGroupId($customer_group_id);
