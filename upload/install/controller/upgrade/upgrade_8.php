...
class Upgrade8 extends \Opencart\System\Engine\Controller {
	public function index(): void {
		...
		try {
			...
			// Country
			$this->db->query("UPDATE `" . DB_PREFIX . "oc_country` SET `address_format_id` = `1` WHERE `address_format_id` = '0'");
