...
class ModelMarketingAffiliate extends Model {
	...
	public function deleteAffiliate($affiliate_id) {
		$this->event->trigger('pre.affiliate.delete', $affiliate_id);
		...
		$this->event->trigger('post.affiliate.delete', $affiliate_id);
	}
	...
	public function approve($affiliate_id) {
		...
		if ($affiliate_info) {
			$this->event->trigger('pre.approve.affiliate', $affiliate_id);
			...
			$this->event->trigger('post.approve.affiliate', $affiliate_id);
		}
	}
	...
	public function addTransaction($affiliate_id, $description = '', $amount = '', $order_id = 0) {
		...
		if ($affiliate_info) {
			$this->event->trigger('pre.affiliate.transaction.add', $affiliate_id);
			...
			$this->event->trigger('post.affiliate.transaction.add', $affiliate_transaction_id);
	...
	public function deleteTransaction($order_id) {
		$this->event->trigger('pre.affiliate.transaction.delete', $order_id);

		$this->db->query("DELETE FROM " . DB_PREFIX . "affiliate_transaction WHERE order_id = '" . (int)$order_id . "'");

		$this->event->trigger('post.affiliate.transaction.delete', $order_id);
	}
