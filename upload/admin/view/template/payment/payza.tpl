...
<div id="content">
  ...
  <div class="panel">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-payza" class="form-horizontal">
      ...
      <div class="control-group required">
        <label class="col-lg-2 control-label" for="input-security"><?php echo $entry_security; ?></label>
        <div class="col-lg-10">
      ...
      <div class="form-group">
        <label class="col-lg-2 control-label" for="input-callback"><?php echo $entry_callback; ?> <span class="help-block"><?php echo $help_callback; ?></span></label>
        <div class="col-lg-10">
