  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="col-sm-<?php echo $cols; ?>"><?php echo $content_top; ?> 
      ...
      <div id="product"> 
        ...
        <div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
          <label class="control-label"><?php echo $option['name']; ?></label>
          <button type="button" id="button-upload<?php echo $option['product_option_id']; ?>" class="btn btn-default btn-block"><i class="icon-upload"></i> <?php echo $button_upload; ?></button>
...
$('button[id^=\'button-upload\']').on('click', function() {
	...
	$('#form-upload input[name=\'file\']').on('change', function() {
		$.ajax({
			...
			processData: false,		
			beforeSend: function() {
				$(node).find('i').replaceWith('<i class="icon-spinner icon-spin"></i>');
				$(node).prop('disabled', true);
			},
			complete: function() {
				$(node).find('i').replaceWith('<i class="icon-upload"></i>');
