...
<div id="content">
  ...
  <div class="box">
    <div class="box-heading">
      ...
      <div class="buttons">
        <button type="submit" form="form-banner" class="btn"><i class="icon-ok"></i> <?php echo $button_save; ?></button>
        ...
        <table id="module" class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr id="module-row<?php echo $module_row; ?>">
              ...
              <td class="left"><input type="text" name="banner_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" placeholder="<?php echo $entry_width; ?>" class="input-mini" />
              ...
              <td class="left"><select name="banner_module[<?php echo $module_row; ?>][store_id]">
              ...
              <td class="left"><select name="banner_module[<?php echo $module_row; ?>][responsive_phone]">
              ...
              <td class="left"><select name="banner_module[<?php echo $module_row; ?>][responsive_tablet]">
              ...
              <td class="left"><select name="banner_module[<?php echo $module_row; ?>][responsive_desktop]">
              ...
              <td class="right"><input type="text" name="banner_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="input-mini" /></td>
...
function addModule() {	
	...
	<?php } ?>
	html += '  </select></td>';
	html += '  <td class="left"><input type="text" name="banner_module[' + module_row + '][width]" value="" placeholder="<?php echo $entry_width; ?>" class="input-mini" /> <input type="text" name="banner_module[' + module_row + '][height]" value="" placeholder="<?php echo $entry_height; ?>" class="input-mini" /></td>'; 
	html += '  <td class="left"><select name="banner_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	html += '    <option value="<?php echo $layout['layout_id']; ?>"><?php echo addslashes($layout['name']); ?></option>';
	<?php } ?>
	html += '  </select></td>';
	html += '  <td class="left"><select name="banner_module[' + module_row + '][store_id]">';
	<?php foreach ($stores as $store) { ?>
	html += '    <option value="<?php echo $store['store_id']; ?>"><?php echo addslashes($store['name']); ?></option>';
	<?php } ?>
	html += '  </select></td>';
	html += '  <td class="left"><select name="banner_module[' + module_row + '][responsive_phone]">';
    html += '    <option value="1" selected="selected"><?php echo $text_visible; ?></option>';
    html += '    <option value="0"><?php echo $text_hidden; ?></option>';
    html += '  </select></td>';
	html += '  <td class="left"><select name="banner_module[' + module_row + '][responsive_tablet]">';
    html += '    <option value="1" selected="selected"><?php echo $text_visible; ?></option>';
    html += '    <option value="0"><?php echo $text_hidden; ?></option>';
    html += '  </select></td>';
	html += '  <td class="left"><select name="banner_module[' + module_row + '][responsive_desktop]">';
    html += '    <option value="1" selected="selected"><?php echo $text_visible; ?></option>';
    html += '    <option value="0"><?php echo $text_hidden; ?></option>';
    html += '  </select></td>';
    ...
    html += '  </select></td>';
	html += '  <td class="right"><input type="text" name="banner_module[' + module_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="input-mini" /></td>';
