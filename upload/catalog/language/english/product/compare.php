...
$_['text_compare']      = 'Product Comparison (%s)';
$_['text_success']      = 'Success: You have added <a href="%s">%s</a> to your <a href="%s">product comparison</a>!';
$_['text_remove']       = 'Success: You have updated the product comparison!';
$_['text_empty']        = 'Nothing to compare! Please choose products to compare.';