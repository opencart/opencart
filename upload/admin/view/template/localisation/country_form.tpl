...
<div id="content">
  ...
  <div class="box">
    <div class="box-heading">
      ...
      <div class="buttons">
        <button type="submit" form="form-country" class="btn"><i class="icon-ok"></i> <?php echo $button_save; ?></button>
    ...
    <div class="box-content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-country" class="form-horizontal">
        ...
        <div class="control-group">
          <label class="control-label" for="input-address-format"><?php echo $entry_address_format; ?> <span class="help-block"><?php echo $help_address_format; ?></span></label>
          <div class="controls">
