<form class="form-horizontal">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <select name="address_id" id="input-payment-address" class="form-control">
...
$('#collapse-payment-address select[name=\'address_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=checkout/checkout/address&address_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
			$('#collapse-payment-address select[name=\'address_id\']').after(' <i class="fa fa-spinner fa-spin"></i>');
		},
		complete: function() {
			$('.fa-spinner').remove();
		},		
		success: function(json) {
			if (json != '') {
				$('#collapse-payment-address input[name=\'firstname\']').attr('value', json['firstname']);
				$('#collapse-payment-address input[name=\'lastname\']').attr('value', json['lastname']);
				$('#collapse-payment-address input[name=\'company\']').attr('value', json['company']);
				$('#collapse-payment-address input[name=\'address_1\']').attr('value', json['address_1']);
				$('#collapse-payment-address input[name=\'address_2\']').attr('value', json['address_2']);
				$('#collapse-payment-address input[name=\'city\']').attr('value', json['city']);
				$('#collapse-payment-address input[name=\'postcode\']').attr('value', json['postcode']);
				$('#collapse-payment-address select[name=\'country_id\']').prop('value', json['country_id']);
				
				payment_zone_id = json['zone_id'];
				
				$('#collapse-payment-address select[name=\'shipping_country_id\']').trigger('change');
			}
		},
