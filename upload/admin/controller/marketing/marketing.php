...
class Marketing extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('marketing/marketing', $url)
		];

		$data['add'] = $this->url->link('marketing/marketing.form', $url);
		$data['delete'] = $this->url->link('marketing/marketing.delete');
	...
	protected function getList(): string {
		...
		$data['action'] = $this->url->link('marketing/marketing.list', $url);
		...
		foreach ($results as $result) {
			$data['marketings'][] = [
				...
				'edit'         => $this->url->link('marketing/marketing.form', 'marketing_id=' . $result['marketing_id'] . $url)
			];
		}
		...
		$data['sort_name'] = $this->url->link('marketing/marketing.list', 'sort=m.name' . $url);
		$data['sort_code'] = $this->url->link('marketing/marketing.list', 'sort=m.code' . $url);
		$data['sort_date_added'] = $this->url->link('marketing/marketing.list', 'sort=m.date_added' . $url);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('marketing/marketing.list', $url . '&page={page}')
		]);
	...
	public function form(): void {
		...
		$data['save'] = $this->url->link('marketing/marketing.save');
		$data['back'] = $this->url->link('marketing/marketing', $url);
	...
	public function getReport(): string {
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $limit,
			'url'   => $this->url->link('marketing/marketing.report', 'marketing_id=' . $marketing_id . '&page={page}')
		]);
