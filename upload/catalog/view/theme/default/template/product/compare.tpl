        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php if ($products[$product['product_id']]['price']) { ?>
              ...
              <?php } else { ?>
              <span class="product-compare price-old"><?php echo $products[$product['product_id']]['price']; ?> </span> <span class="price-new"> <?php echo $products[$product['product_id']]['special']; ?> </span>
              <?php } ?>
              <?php } ?></td>
            <?php } ?>
          </tr>
