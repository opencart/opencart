...
<div class="navbar">
  <div class="nav-inner navbar-inverse">
    <div class="navbar-inner">
      <div class="container-fluid"><a href="<?php echo $home; ?>" id="logo" class="brand"><img src="view/image/logo.png" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" /></a>
        <?php if ($logged) { ?>
        <ul class="nav">
          <li id="dashboard"><a href="<?php echo $home; ?>"><?php echo $text_dashboard; ?></a></li>
          <li class="dropdown" id="catalog"><a class="dropdown-toggle" data-toggle="dropdown"><?php echo $text_catalog; ?></a>
          ...
          <li class="dropdown" id="extension"><a class="dropdown-toggle" data-toggle="dropdown"><?php echo $text_extension; ?></a>
            <ul class="dropdown-menu">
          ...
          <li class="dropdown" id="sale"><a class="dropdown-toggle" data-toggle="dropdown"><?php echo $text_sale; ?></a>
            <ul class="dropdown-menu">
          ...
          <li class="dropdown" id="system"><a class="dropdown-toggle" data-toggle="dropdown"><?php echo $text_system; ?></a>
            <ul class="dropdown-menu">
          ...
          <li class="dropdown" id="reports"><a class="dropdown-toggle" data-toggle="dropdown"><?php echo $text_reports; ?></a>
            <ul class="dropdown-menu">
          ...
          <li class="dropdown" id="help"><a class="dropdown-toggle" data-toggle="dropdown"><?php echo $text_help; ?></a>
            <ul class="dropdown-menu">
        ...
        <ul class="nav pull-right">
          <li class="dropdown" id="store"><a href="<?php echo $store; ?>" target="_blank" class="dropdown-toggle" data-toggle="dropdown"><?php echo $text_front; ?></a>
            <?php if ($stores) { ?>
            <ul class="dropdown-menu">
