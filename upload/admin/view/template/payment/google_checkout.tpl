...
<div id="content">
  ...
  <div class="box">
    <div class="box-heading">
      ...
      <div class="buttons">
        <button type="submit" form="form-google-checkout" class="btn btn-primary"><i class="icon-ok"></i> <?php echo $button_save; ?></button>
    ...
    <div class="box-content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-google-checkout" class="form-horizontal">
        ...
        <div class="control-group required">
          <label class="control-label" for="input-merchant-key"><?php echo $entry_merchant_key; ?></label>
          <div class="controls">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <select name="google_checkout_geo_zone_id" id="input-geo-zone">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <select name="google_checkout_status" id="input-status">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input type="text" name="google_checkout_sort_order" value="<?php echo $google_checkout_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="input-mini" />
          </div>
        </div>
      </form>
    </div>
