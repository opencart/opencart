<?php
// HTTP
define('HTTP_SERVER', 'http://' . $_SERVER['HTTP_HOST'] . '/opencart/upload/');
define('HTTP_IMAGE', 'http://' . $_SERVER['HTTP_HOST'] . '/opencart/upload/image/');
define('HTTP_ADMIN', 'http://' . $_SERVER['HTTP_HOST'] . '/opencart/upload/admin/');

// HTTPS
define('HTTPS_SERVER', 'http://' . $_SERVER['HTTP_HOST'] . '/opencart/upload/');
define('HTTPS_IMAGE', 'http://' . $_SERVER['HTTP_HOST'] . '/opencart/upload/image/');
