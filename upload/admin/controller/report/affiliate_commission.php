...
class ControllerReportAffiliateCommission extends Controller {
	public function index() {     
		...
		$this->data['results'] = sprintf($this->language->get('text_pagination'), ($affiliate_commission_total) ? (($page - 1) * $this->config->get('config_admin_limit')) + 1 : 0, ((($page - 1) * $this->config->get('config_admin_limit')) > ($affiliate_commission_total - $this->config->get('config_admin_limit'))) ? $affiliate_commission_total : ((($page - 1) * $this->config->get('config_admin_limit')) + $this->config->get('config_admin_limit')), $affiliate_total, ceil($affiliate_commission_total / $this->config->get('config_admin_limit')));
