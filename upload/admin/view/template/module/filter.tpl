...
<div id="content">
  ...
  <div class="box">
    <div class="box-heading">
      ...
      <div class="buttons">
        <button type="submit" form="form-filter" class="btn"><i class="icon-ok"></i> <?php echo $button_save; ?></button>
        ...
        <table id="module" class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr id="module-row<?php echo $module_row; ?>">
              ...
              <td class="left"><select name="filter_module[<?php echo $module_row; ?>][store_id]">
              ...
              <td class="left"><select name="filter_module[<?php echo $module_row; ?>][responsive_phone]">
              ...
              <td class="left"><select name="filter_module[<?php echo $module_row; ?>][responsive_tablet]">
              ...
              <td class="left"><select name="filter_module[<?php echo $module_row; ?>][responsive_desktop]">
...
function addModule() {	
	...
	<?php } ?>
	html += '  </select></td>';
	html += '  <td class="left"><select name="filter_module[' + module_row + '][store_id]">';
	<?php foreach ($stores as $store) { ?>
	html += '    <option value="<?php echo $store['store_id']; ?>"><?php echo addslashes($store['name']); ?></option>';
	<?php } ?>
	html += '  </select></td>';
	html += '  <td class="left"><select name="filter_module[' + module_row + '][responsive_phone]">';
    html += '    <option value="1" selected="selected"><?php echo $text_visible; ?></option>';
    html += '    <option value="0"><?php echo $text_hidden; ?></option>';
    html += '  </select></td>';
	html += '  <td class="left"><select name="filter_module[' + module_row + '][responsive_tablet]">';
    html += '    <option value="1" selected="selected"><?php echo $text_visible; ?></option>';
    html += '    <option value="0"><?php echo $text_hidden; ?></option>';
    html += '  </select></td>';
	html += '  <td class="left"><select name="filter_module[' + module_row + '][responsive_desktop]">';
    html += '    <option value="1" selected="selected"><?php echo $text_visible; ?></option>';
    html += '    <option value="0"><?php echo $text_hidden; ?></option>';
    html += '  </select></td>';
