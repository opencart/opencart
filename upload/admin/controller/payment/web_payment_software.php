...
class ControllerPaymentWebPaymentSoftware extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->ssl('payment/web_payment_software', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->ssl('payment/web_payment_software', 'token=' . $this->session->data['token'], true);
