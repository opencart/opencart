...
class Zone extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('localisation/zone', $url)
		];

		$data['add'] = $this->url->link('localisation/zone.form', $url);
		$data['delete'] = $this->url->link('localisation/zone.delete');
	...
	protected function getList(): string {
		...
		$data['action'] = $this->url->link('localisation/zone.list', $url);
		...
		foreach ($results as $result) {
			$data['zones'][] = [
				...
				'edit'    => $this->url->link('localisation/zone.form', 'zone_id=' . $result['zone_id'] . $url)
			];
		}
		...
		$data['sort_country'] = $this->url->link('localisation/zone.list', 'sort=c.name' . $url);
		$data['sort_name'] = $this->url->link('localisation/zone.list', 'sort=z.name' . $url);
		$data['sort_code'] = $this->url->link('localisation/zone.list', 'sort=z.code' . $url);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('localisation/zone.list', $url . '&page={page}')
		]);
	...
	public function form(): void {
		...
		$data['save'] = $this->url->link('localisation/zone.save');
		$data['back'] = $this->url->link('localisation/zone', $url);
