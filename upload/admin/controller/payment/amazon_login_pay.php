...
class ControllerPaymentAmazonLoginPay extends Controller {
    ...
    public function index() {
        ...
        if ($this->config->get('amazon_login_pay_marketplace') && $this->config->get('amazon_login_pay_marketplace') != 'us') {
            $this->load->language('payment/amazon_login_pay_' . $this->config->get('amazon_login_pay_marketplace'));
        } else {
        ...
        if (isset($this->request->post['amazon_login_pay_marketplace'])) {
            $data['language'] = $this->request->post['amazon_login_pay_marketplace'];
        } elseif ($this->config->get('amazon_login_pay_marketplace')) {
            $data['language'] = $this->config->get('amazon_login_pay_marketplace');
        } else {
            $data['language'] = 'us';
        }
