      ...
      <div class="tabbable tabs-left">
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tab-general">
            ...
            <div class="form-group">
              <div class="col-lg-2 control-label"><?php echo $entry_display_insurance; ?> <span class="help-block"><?php echo $help_display_insurance; ?></span></div>
              <div class="col-lg-10">
                <label class="radio inline">
          ...
          <div class="tab-pane" id="tab-1st-class-standard">
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-1st-class-standard-rate"><?php echo $entry_rate; ?> <span class="help-block"><?php echo $help_rate; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-1st-class-standard-insurance"><?php echo $entry_insurance; ?> <span class="help-block"><?php echo $help_insurance; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-input-1st-class-standard-status"><?php echo $entry_status; ?></label>
              <div class="col-lg-10">
          ...
          <div class="tab-pane" id="tab-1st-class-recorded">
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-1st-class-recorded-rate"><?php echo $entry_rate; ?> <span class="help-block"><?php echo $help_rate; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-1st-class-recorded-insurance"><?php echo $entry_insurance; ?> <span class="help-block"><?php echo $help_insurance; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-1st-class-recorded-status"><?php echo $entry_status; ?></label>
              <div class="col-lg-10">
          ...
          <div class="tab-pane" id="tab-2nd-class-standard">
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-2nd-class-standard-rate"><?php echo $entry_rate; ?> <span class="help-block"><?php echo $help_rate; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-2nd-class-standard-status"><?php echo $entry_status; ?></label>
              <div class="col-lg-10">
          ...
          <div class="tab-pane" id="tab-2nd-class-recorded">
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-2nd-class-recorded-rate"><?php echo $entry_rate; ?> <span class="help-block"><?php echo $help_rate; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-2nd-class-recorded-insurance"><?php echo $entry_insurance; ?> <span class="help-block"><?php echo $help_insurance; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-2nd-class-recorded-status"><?php echo $entry_status; ?></label>
              <div class="col-lg-10">
          ...
          <div class="tab-pane" id="tab-special-delivery-500">
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-special-delivery-500-rate"><?php echo $entry_rate; ?> <span class="help-block"><?php echo $help_rate; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-special-delivery-500-insurance"><?php echo $entry_insurance; ?> <span class="help-block"><?php echo $help_insurance; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-special-delivery-500-status"><?php echo $entry_status; ?></label>
              <div class="col-lg-10">
          ...
          <div class="tab-pane" id="tab-special-delivery-1000">
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-special-delivery-1000-rate"><?php echo $entry_rate; ?> <span class="help-block"><?php echo $help_rate; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-special-delivery-1000-insurance"><?php echo $entry_insurance; ?> <span class="help-block"><?php echo $help_insurance; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-special-delivery-1000-status"><?php echo $entry_status; ?></label>
              <div class="col-lg-10">
          ...
          <div class="tab-pane" id="tab-special-delivery-2500">
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-special-delivery-2500-rate"><?php echo $entry_rate; ?> <span class="help-block"><?php echo $help_rate; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-special-delivery-2500-insurance"><?php echo $entry_insurance; ?> <span class="help-block"><?php echo $help_insurance; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-special-delivery-2500-status"><?php echo $entry_status; ?></label>
              <div class="col-lg-10">
          ...
          <div class="tab-pane" id="tab-standard-parcels">
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-standard-parcels-rate"><?php echo $entry_rate; ?> <span class="help-block"><?php echo $help_rate; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-standard-parcels-insurance"><?php echo $entry_insurance; ?> <span class="help-block"><?php echo $help_insurance; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-standard-parcels-status"><?php echo $entry_status; ?></label>
              <div class="col-lg-10">
          ...
          <div class="tab-pane" id="tab-airmail">
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-airmail-rate-1"><?php echo $entry_rate; ?> <span class="help-block"><?php echo $help_airmail_rate_1; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-airmail-rate-2"><?php echo $entry_rate; ?> <span class="help-block"><?php echo $help_airmail_rate_2; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-airmail-status"><?php echo $entry_status; ?></label>
              <div class="col-lg-10">
          ...
          <div class="tab-pane" id="tab-international-signed">
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-international-signed-rate-1"><?php echo $entry_rate; ?> <span class="help-block"><?php echo $help_international_signed_rate_1; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-international-signed-insurance-1"><?php echo $entry_insurance; ?> <span class="help-block"><?php echo $help_international_signed_insurance_1; ?></span></label>
              <div class="col-lg-10"> </div>
            </div>
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-international-signed-rate-2"><?php echo $entry_rate; ?> <span class="help-block"><?php echo $help_international_signed_rate_2; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-international-signed-insurance-2"><?php echo $entry_insurance; ?> <span class="help-block"><?php echo $help_international_signed_insurance_2; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-international-signed-rate-status"><?php echo $entry_status; ?></label>
              <div class="col-lg-10">
          ...
          <div class="tab-pane" id="tab-airsure">
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-airsure-rate-1"><?php echo $entry_rate; ?> <span class="help-block"><?php echo $help_airsure_rate_1; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-airsure-insurance-1"><?php echo $entry_insurance; ?> <span class="help-block"><?php echo $help_airsure_insurance_1; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-airsure-rate-2"><?php echo $entry_rate; ?> <span class="help-block"><?php echo $help_airsure_rate_2; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-airsure-insurance-2"><?php echo $entry_insurance; ?> <span class="help-block"><?php echo $help_airsure_insurance_2; ?></span></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-airsure-status"><?php echo $entry_status; ?></label>
              <div class="col-lg-10">
          ...
          <div class="tab-pane" id="tab-surface">
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-surface-rate"><?php echo $entry_rate; ?></label>
              <div class="col-lg-10">
            ...
            <div class="form-group">
              <label class="col-lg-2 control-label" for="input-surface-status"><?php echo $entry_status; ?></label>
              <div class="col-lg-10">
