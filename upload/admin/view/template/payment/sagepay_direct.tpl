  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-sagepay-direct" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-check-circle"></i></button>
  ...
  <div class="container-fluid">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sagepay-direct" class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10"> <span><?php echo $sagepay_direct_last_cron_job_run ?></span> </div>
      </div>
    </form>
  </div>
</div>
