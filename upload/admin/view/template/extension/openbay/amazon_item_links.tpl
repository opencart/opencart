    ...
    $.ajax({
      ...
      success: function (json) {
        ...
        for (i in json) {
          ...
          rows += '<td class="text-center"><a data-toggle="tooltip" data-original-title="<?php echo $button_remove; ?>" class="btn btn-danger" onclick="removeLink(this, \'' + json[i]['amazon_sku'] + '\');"><i class="mi mi-times-circle">cancel</i></a></td>';
          rows += '</tr>';
        }
