      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-pp-layout">
        <table id="module" class="table table-striped table-bordered table-hover">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              <td class="text-left">
                <select name="pp_layout_module[<?php echo $module_row; ?>][layout_id]" class="form-control">
              ...
              <td class="text-left">
                <select name="pp_layout_module[<?php echo $module_row; ?>][position]" class="form-control">
              ...
              <td class="text-left">
                <select name="pp_layout_module[<?php echo $module_row; ?>][status]" class="form-control">
