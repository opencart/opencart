      ...
      <table id="images" class="table table-striped table-bordered table-hover">
        ...
        <tbody>
          ...
          <tr id="image-row<?php echo $image_row; ?>">
            ...
            <?php if ($banner_image['banner_image_description'][$language['language_id']]['thumb']) { ?>
              <a href="" id="thumb-image<?php echo $image_row; ?><?php echo $language['language_id']; ?>" class="img-thumbnail img-edit"><img src="<?php echo $banner_image['banner_image_description'][$language['language_id']]['thumb']; ?>" alt="" title="" /></a>
              <?php } else { ?>
              <a href="" id="thumb-image<?php echo $image_row; ?><?php echo $language['language_id']; ?>" class="img-thumbnail img-edit"><i class="fa fa-camera fa-5x"></i></a>
              <?php } ?>
              <input type="hidden" name="banner_image[<?php echo $image_row; ?>][banner_image_description][<?php echo $language['language_id']; ?>][image]" value="<?php echo $banner_image['banner_image_description'][$language['language_id']]['image']; ?>" id="input-image<?php echo $image_row; ?><?php echo $language['language_id']; ?>" />
			  </div>
              <?php } ?></td>
...
function addImage() {
	...
	html += '	   <a href="" id="thumb-image' + image_row + '<?php echo $language['language_id']; ?>" class="img-thumbnail img-edit"><i class="fa fa-camera fa-5x"></i></a><input type="hidden" name="banner_image[' + image_row + '][banner_image_description][<?php echo $language['language_id']; ?>][image]" value="" id="input-image' + image_row + '<?php echo $language['language_id']; ?>" />';
    html += '    </div>';
	<?php } ?>
	html += '  </td>';
