<?php
class ControllerThemeTest extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$data['action'] = $this->url->link('theme/test', 'token=' . $this->session->data['token'] . '&store_id=' . $this->request->get['store_id'], true);
