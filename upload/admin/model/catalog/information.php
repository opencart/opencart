...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		$this->event->trigger('pre.information.add', $data);
		...
		$this->event->trigger('post.information.add', $information_id);

		return $information_id;
	}

	public function editInformation($information_id, $data) {
		$this->event->trigger('pre.information.edit', $data);
		...
		$this->event->trigger('post.information.edit', $information_id);
	}

	public function deleteInformation($information_id) {
		$this->event->trigger('pre.information.delete', $information_id);
		...
		$this->event->trigger('post.information.delete', $information_id);
	}
