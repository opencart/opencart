  ...
  <div class="box">
    ...
    <div class="box-content">
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data">
        <div class="buttons"><a href="<?php echo $repair; ?>" class="btn"><i class="icon-wrench"></i> <?php echo $button_repair; ?></a> <a href="<?php echo $insert; ?>" class="btn"><i class="icon-plus"></i> <?php echo $button_insert; ?></a> <button type="submit" class="btn"><i class="icon-trash"></i> <?php echo $button_delete; ?></button></div>
