...
class PhoneNumberMetadata_KN extends PhoneMetadata
{
    ...
    public function __construct()
    {
        ...
        $this->mobile = (new PhoneNumberDesc())
            ->setNationalNumberPattern('869(?:48[89]|55[6-8]|66\d|76[02-7])\d{4}')
            ->setExampleNumber('8697652917')
            ->setPossibleLengthLocalOnly([7]);
        $this->premiumRate = (new PhoneNumberDesc())
            ->setNationalNumberPattern('900[2-9]\d{6}')
            ->setExampleNumber('9002123456');
        $this->fixedLine = (new PhoneNumberDesc())
            ->setNationalNumberPattern('869(?:2(?:29|36)|302|4(?:6[015-9]|70)|56[5-7])\d{4}')
            ->setExampleNumber('8692361234')
            ->setPossibleLengthLocalOnly([7]);
