<div class="list-group">
  ...
  <?php } ?>
  <a href="<?php echo $payment; ?>" class="list-group-item">{{ text_payment; ?></a> <a href="<?php echo $tracking; ?>" class="list-group-item">{{ text_tracking }}</a> <a href="<?php echo $transaction; ?>" class="list-group-item"><?php echo $text_transaction }}</a>
  <?php if ($logged) { ?>
