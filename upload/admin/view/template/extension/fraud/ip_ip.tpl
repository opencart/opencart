  ...
  <table class="table table-bordered table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-right"><button type="button" value="<?php echo $ip['ip']; ?>" data-toggle="tooltip" title="<?php echo $button_remove; ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-danger"><i class="mi mi-minus-circle">remove circle</i></button></td>
      </tr>
      <?php } ?>
      <?php } else { ?>
      <tr>
