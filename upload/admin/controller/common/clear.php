<?php
class ControllerCommonClear extends Controller {
    public function clearCache() {
        $this->load->language('common/clear');

        $json = array();

        if (!$this->user->hasPermission('modify', 'common/clear')) {
    ...
    public function clearLog() {
        ...
        if (!$this->user->hasPermission('modify', 'common/clear') || empty($this->request->post['key'])) {
            $json['error'] = $this->language->get('error_permission');
        } else {
            $key = $this->request->post['key'];
