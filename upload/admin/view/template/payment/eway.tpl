  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-eway" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-check-circle"></i></button>
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-eway" class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-10">
          ...
          <span class="help-block"><?php echo $help_testmode; ?></span>
        </div>
      </div>
      ...
      <div class="form-group">
        <label class="col-sm-2 control-label" for="input-transaction-method"><?php echo $entry_transaction_method; ?></label>
        <div class="col-sm-10">
          ...
          <?php } ?>
			...
			<span class="help-block"><?php echo $help_transaction_method; ?></span>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <p>
            ...
            <input type='checkbox' name='eway_payment_type[visa]' value='1' <?php echo (isset($eway_payment_type['visa']) && $eway_payment_type['visa'] == 1 ? 'checked="checked"' : '') ?> /> CC - Visa
          </p>
          <p>
          ...
          <p>
            ...
            <input type='checkbox' name='eway_payment_type[vme]' value='1' <?php echo (isset($eway_payment_type['vme']) && $eway_payment_type['vme'] == 1 ? 'checked="checked"' : '') ?> /> V.me By Visa
          </p>
		  -->
          <div class="text-danger"><?php echo $error_payment_type; ?></div>
          <span class="help-block"><?php echo $help_payment_type; ?></span>
        </div>
      </div>
      <div class="form-group">
