  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-category" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="mi mi-save">save</i></button>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="category-filter" class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div id="category-filter<?php echo $category_filter['filter_id']; ?>"><i class="mi mi-minus-circle">remove circle</i> <?php echo $category_filter['name']; ?>
...
$('input[name=\'filter\']').autocomplete({
	...
	'select': function(item) {
		...
		$('#category-filter').append('<div id="category-filter' + item['value'] + '"><i class="mi mi-minus-circle">remove circle</i> ' + item['label'] + '<input type="hidden" name="category_filter[]" value="' + item['value'] + '" /></div>');
	}
});

$('#category-filter').delegate('.mi-minus-circle', 'click', function() {
	$(this).parent().remove();
});
//--></script> 
  <script type="text/javascript"><!--
