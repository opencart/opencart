  ...
  <div id="tab_general" class="page">
    <table class="form">
      <tr>
        ...
        <td><input type="text" name="paypal_email" value="<?php echo $paypal_email; ?>" />
          <br />
          <?php if ($error_email) { ?>
      ...
      <tr>
        ...
        <td><?php if ($paypal_test) { ?>
          ...
          <?php echo $text_yes; ?>
          <input type="radio" name="paypal_test" value="0" />
          <?php echo $text_no; ?>
          <?php } else { ?>
          <input type="radio" name="paypal_test" value="1" />
          <?php echo $text_yes; ?>
      ...
      <tr>
        ...
        <td><select name="paypal_order_status_id">
            <?php foreach ($order_statuses as $order_status) { ?>
            <?php if ($order_status['order_status_id'] == $paypal_order_status_id) { ?>
      ...
      <tr>
        ...
        <td><select name="paypal_geo_zone_id">
            <option value="0"><?php echo $text_all_zones; ?></option>
            <?php foreach ($geo_zones as $geo_zone) { ?>
            <?php if ($geo_zone['geo_zone_id'] == $paypal_geo_zone_id) { ?>
      ...
      <tr>
        ...
        <td><input type="text" name="paypal_sort_order" value="<?php echo $paypal_sort_order; ?>" size="1" /></td>
      </tr>
    </table>
  </div>
</form>
