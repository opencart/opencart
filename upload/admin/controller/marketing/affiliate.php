...
class Affiliate extends \Opencart\System\Engine\Controller {
	...
	public function getList(): string {
		...
		$data['sort_tracking'] = $this->url->link('marketing/affiliate.list', 'user_token=' . $this->session->data['user_token'] . '&sort=tracking' . $url);
		$data['sort_commission'] = $this->url->link('marketing/affiliate.list', 'user_token=' . $this->session->data['user_token'] . '&sort=commission' . $url);
	...
	public function enable(): void {
		...
		if (!$json) {
			...
			foreach ($selected as $affiliate_id) {
				$this->model_marketing_affiliate->editStatus((int)$affiliate_id, true);
			}
	...
	private function getReport(): string {
		...
		$data['page'] = $page;
		$data['limit'] = $this->config->get('config_pagination_admin');
		$data['pagination'] = $this->url->link('marketing/affiliate.report', 'user_token=' . $this->session->data['user_token'] . '&customer_id=' . $customer_id . '&page={page}');
