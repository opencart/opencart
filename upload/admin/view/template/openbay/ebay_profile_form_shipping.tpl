                        ...
                        <div class="well shipping_national_<?php echo $key; ?>">
                          ...
                          <?php if ($cod_surcharge == 1) { ?>
                            <div class="row">
                              ...
                              <div class="col-sm-10">
                                <input type="text" name="data[cod_surcharge_national][<?php echo $key; ?>]" class="form-control" value="<?php echo $service['cod_surcharge']; ?>" />
                              </div>
                            </div>
                          <?php } else { ?>
                            <input type="hidden" name="data[cod_surcharge_national][<?php echo $key; ?>]" value="0" />
                          <?php } ?>
                        </div>
                      <?php } ?>
                    <?php } ?>
