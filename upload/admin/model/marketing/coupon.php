...
class ModelMarketingCoupon extends Model {
	public function addCoupon($data) {
		$this->event->trigger('pre.coupon.add', $data);
		...
		$this->event->trigger('post.coupon.add', $coupon_id);

		return $coupon_id;
	}

	public function editCoupon($coupon_id, $data) {
		$this->event->trigger('pre.coupon.edit', $data);
		...
		$this->event->trigger('post.coupon.edit', $coupon_id);
	}

	public function deleteCoupon($coupon_id) {
		$this->event->trigger('pre.coupon.delete', $coupon_id);
		...
		$this->event->trigger('post.coupon.delete', $coupon_id);
	}
