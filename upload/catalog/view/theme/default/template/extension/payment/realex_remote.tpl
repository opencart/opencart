...
$('#button-confirm').bind('click', function() {
  $.ajax({
    ...
    beforeSend: function() {
      ...
      $('#payment').before('<div id="realex-message-wait" class="alert alert-info"><i class="mi mi-info-circle">info</i> <?php echo $text_wait; ?></div>');
    },
    success: function(json) {
      ...
      // if error
      if (json['error']) {
        $('#payment').before('<div id="realex-message-error" class="alert alert-warning"><i class="mi mi-info-circle">info</i> '+json['error']+'</div>');
