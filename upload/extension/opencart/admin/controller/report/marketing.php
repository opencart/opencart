...
class Marketing extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/opencart/report/marketing')
		];

		$data['save'] = $this->url->link('extension/opencart/report/marketing.save');
	...
	public function getReport(): string {
		...
		foreach ($results as $result) {
			$data['marketings'][] = [
				...
				'save'     => $this->url->link('marketing/marketing/edit', 'marketing_id=' . $result['marketing_id'])
			];
		}
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination'),
			'url'   => $this->url->link('extension/opencart/report/marketing.report', 'code=marketing' . $url . '&page={page}')
		]);
