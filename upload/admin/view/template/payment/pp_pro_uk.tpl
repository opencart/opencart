...
<div class="container">
  ...
  <div class="panel">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-pp-pro-uk" class="form-horizontal">
      ...
      <div class="form-group required">
        <label class="col-lg-3 control-label" for="input-user"><?php echo $entry_user; ?></label>
        <div class="col-lg-9">
      ...
      <div class="form-group required">
        <label class="col-lg-3 control-label" for="input-partner"><?php echo $entry_partner; ?></label>
        <div class="col-lg-9">
