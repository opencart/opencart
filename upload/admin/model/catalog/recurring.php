...
class ModelCatalogRecurring extends Model {
	public function addRecurring($data) {
		$this->event->trigger('pre.admin.add.recurring', $data);
		...
		$this->event->trigger('post.admin.add.recurring', $recurring_id);

		return $recurring_id;
	}

	public function editRecurring($recurring_id, $data) {
		$this->event->trigger('pre.admin.edit.recurring', $data);
		...
		$this->event->trigger('post.admin.edit.recurring', $recurring_id);
	}
	...
	public function deleteRecurring($recurring_id) {
		$this->event->trigger('pre.admin.delete.recurring', $recurring_id);
		...
		$this->event->trigger('post.admin.delete.recurring', $recurring_id);
	}
