...
class Upload extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('tool/upload', $url)
		];

		$data['add'] = $this->url->link('tool/upload.form', $url);
		$data['delete'] = $this->url->link('tool/upload.delete');
	...
	protected function getList(): string {
		...
		$data['action'] = $this->url->link('tool/upload.list', $url);
		...
		foreach ($results as $result) {
			$data['uploads'][] = [
				...
				'download'   => $this->url->link('tool/upload.download', 'code=' . $result['code'] . $url)
			];
		}
		...
		$data['sort_name'] = $this->url->link('tool/upload.list', 'sort=name' . $url);
		$data['sort_code'] = $this->url->link('tool/upload.list', 'sort=code' . $url);
		$data['sort_date_added'] = $this->url->link('tool/upload.list', 'sort=date_added' . $url);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('tool/upload.list', $url . '&page={page}')
		]);
