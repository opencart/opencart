              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="tab-<?php echo $country['code']; ?>">
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="klarna_account[<?php echo $country['code']; ?>][merchant]" value="<?php echo isset($klarna_account[$country['code']]) ? $klarna_account[$country['code']]['merchant'] : ''; ?>" placeholder="<?php echo $entry_merchant; ?>" id="input-merchant" />
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="klarna_account[<?php echo $country['code']; ?>][secret]" value="<?php echo isset($klarna_account[$country['code']]) ? $klarna_account[$country['code']]['secret'] : ''; ?>" placeholder="<?php echo $entry_secret; ?>" id="input-secret" />
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <select name="klarna_account[<?php echo $country['code']; ?>][server]" id="input-server">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="klarna_account[<?php echo $country['code']; ?>][total]" value="<?php echo isset($klarna_account[$country['code']]) ? $klarna_account[$country['code']]['total'] : ''; ?>" placeholder="<?php echo $entry_total; ?>" id="input-total" />
                      <span class="help-block"><?php echo $help_total; ?></span></div>
                  </div>
                  <div class="control-group">
                    <label class="control-label" for="input-pending-status"><?php echo $entry_pending_status; ?></label>
                    <div class="controls">
                      <select name="klarna_account[<?php echo $country['code']; ?>][pending_status_id]" id="input-pending-status">
                  ...
                  <div class="control-group">
                    <label class="control-label" for="input-accepted-status"><?php echo $entry_accepted_status; ?></label>
                    <div class="controls">
                      <select name="klarna_account[<?php echo $country['code']; ?>][accepted_status_id]" id="input-accepted-status">
                        <?php foreach ($order_statuses as $order_status) { ?>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <select name="klarna_account[<?php echo $country['code']; ?>][geo_zone_id]" id="input-geo-zone">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <select name="klarna_account[<?php echo $country['code']; ?>][status]" id="input-status">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="klarna_account[<?php echo $country['code']; ?>][sort_order]" value="<?php echo isset($klarna_account[$country['code']]) ? $klarna_account[$country['code']]['sort_order'] : ''; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order">
                    </div>
                  </div>
                </div>
                <?php } ?>
