...
class ModelMarketingCoupon extends Model {
	public function addCoupon($data) {
		$this->event->trigger('pre.admin.add.coupon', $data);
		...
		$this->event->trigger('post.admin.add.coupon', $coupon_id);

		return $coupon_id;
	}

	public function editCoupon($coupon_id, $data) {
		$this->event->trigger('pre.admin.edit.coupon', $data);
		...
		$this->event->trigger('post.admin.edit.coupon', $coupon_id);
	}

	public function deleteCoupon($coupon_id) {
		$this->event->trigger('pre.admin.delete.coupon', $coupon_id);
		...
		$this->event->trigger('post.admin.delete.coupon', $coupon_id);
	}
