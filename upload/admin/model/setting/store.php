...
class Store extends \Opencart\System\Engine\Model {
	...
	public function getTotalStoresByLayoutId($layout_id): int {
	...
	public function getTotalStoresByCountryId($country_id): int {
	...
	public function getTotalStoresByZoneId($zone_id): int {
	...
	public function getTotalStoresByCustomerGroupId($customer_group_id): int {
	...
	public function getTotalStoresByInformationId($information_id): int {
	...
	public function getTotalStoresByOrderStatusId($order_status_id): int {
