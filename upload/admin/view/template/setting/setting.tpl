    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane" id="tab-local">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label" for="input-currency"><?php echo $entry_currency; ?></label>
            <div class="col-lg-9">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo $entry_currency_auto; ?></label>
            <div class="col-lg-9">
        ...
        <div class="tab-pane" id="tab-option">
          <fieldset>
            ...
            <div class="form-group required">
              <label class="col-lg-3 control-label" for="input-catalog-limit"><?php echo $entry_catalog_limit; ?></label>
              <div class="col-lg-9">
            ...
            <div class="form-group required">
              <label class="col-lg-3 control-label" for="input-list-description-limit"><?php echo $entry_list_description_limit; ?> </label>
              <div class="col-lg-9">
            ...
            <div class="form-group required">
              <label class="col-lg-3 control-label" for="input-admin-limit"><?php echo $entry_admin_limit; ?></label>
              <div class="col-lg-9">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label"><?php echo $entry_product_count; ?></label>
              <div class="col-lg-9">
                <label class="radio-inline">
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label"><?php echo $entry_review; ?></label>
              <div class="col-lg-9">
                <label class="radio-inline">
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label"><?php echo $entry_guest_review; ?></label>
              <div class="col-lg-9">
                <label class="radio-inline">
                ...
                <span class="help-block"><?php echo $help_guest_review; ?></span>
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label"><?php echo $entry_download; ?></label>
              <div class="col-lg-9">
                <label class="radio-inline">
          ...
          <fieldset>
            ...
            <div class="form-group required">
              <label class="col-lg-3 control-label" for="input-voucher-min"><?php echo $entry_voucher_min; ?></label>
              <div class="col-lg-9">
            ...
            <div class="form-group required">
              <label class="col-lg-3 control-label" for="input-voucher-max"><?php echo $entry_voucher_max; ?></label>
              <div class="col-lg-9">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label"><?php echo $entry_tax; ?></label>
              <div class="col-lg-9">
                <label class="radio-inline">
                  <?php if ($config_tax) { ?>
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label" for="input-tax-default"><?php echo $entry_tax_default; ?></label>
              <div class="col-lg-9">
                ...
                <span class="help-block"><?php echo $help_tax_default; ?></span>
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label" for="input-tax-customer"><?php echo $entry_tax_customer; ?></label>
              <div class="col-lg-9">
                ...
                <span class="help-block"><?php echo $help_tax_customer; ?></span>
              </div>
            </div>
          </fieldset>
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label"><?php echo $entry_customer_online; ?></label>
              <div class="col-lg-9">
                <label class="radio-inline">
                ...
                <span class="help-block"><?php echo $help_customer_online; ?></span>
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label" for="input-customer-group"><?php echo $entry_customer_group; ?>s</label>
              <div class="col-lg-9">
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label"><?php echo $entry_customer_group_display; ?> </label>
              <div class="col-lg-9">
                <?php foreach ($customer_groups as $customer_group) { ?>
                <div class="checkbox">
                <label>
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label"><?php echo $entry_customer_price; ?>s</label>
              <div class="col-lg-9">
                <label class="radio-inline">
                ...
                <span class="help-block"><?php echo $help_customer_price; ?></span>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-lg-9">
                ...
                <span class="help-block"><?php echo $help_account; ?></span>
              </div>
            </div>
          </fieldset>
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label"><?php echo $entry_cart_weight; ?></label>
              <div class="col-lg-9">
                <label class="radio-inline">
                ...
                <span class="help-block"><?php echo $help_cart_weight; ?></span>
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label"><?php echo $entry_guest_checkout; ?></label>
              <div class="col-lg-9">
                <label class="radio-inline">
                ...
                <span class="help-block"><?php echo $help_guest_checkout; ?></span>
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label" for="input-checkout"><?php echo $entry_checkout; ?></label>
              <div class="col-lg-9">
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label" for="input-order-edit"><?php echo $entry_order_edit; ?></label>
              <div class="col-lg-9">
                ...
                <span class="help-block"><?php echo $help_order_edit; ?></span>
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label" for="input-invoice-prefix"><?php echo $entry_invoice_prefix; ?></label>
              <div class="col-lg-9">
                ...
                <span class="help-block"><?php echo $help_invoice_prefix; ?></span>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label" for="input-complete-status"><?php echo $entry_complete_status; ?></label>
              <div class="col-lg-9">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label"><?php echo $entry_stock_display; ?></label>
              <div class="col-lg-9">
                <label class="radio-inline">
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label"><?php echo $entry_stock_warning; ?></label>
              <div class="col-lg-9">
                <label class="radio-inline">
                ...
                <span class="help-block"><?php echo $help_stock_warning; ?></span>
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 control-label"><?php echo $entry_stock_checkout; ?></label>
              <div class="col-lg-9">
                <label class="radio-inline">
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label" for="input-stock-status"><?php echo $entry_stock_status; ?></label>
              <div class="col-lg-9">
                ...
                <span class="help-block"><?php echo $help_stock_status; ?></span>
              </div>
            </div>
          </fieldset>
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label" for="input-commission"><?php echo $entry_commission; ?></label>
              <div class="col-lg-9">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-lg-3 control-label" for="input-return"><?php echo $entry_return; ?></label>
              <div class="col-lg-9">
                ...
                <span class="help-block"><?php echo $help_return; ?></span>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-lg-9">
                ...
                <span class="help-block"><?php echo $help_return_status; ?></span>
              </div>
            </div>
          </fieldset>
        </div>
        <div class="tab-pane" id="tab-image">
          <div class="form-group">
            ...
            <div class="col-lg-9">
              <img src="<?php echo $logo; ?>" alt="" class="img-thumbnail" />
              <input type="hidden" name="config_logo" value="<?php echo $config_logo; ?>" /><br />
              <br />
              <div class="btn-group"><button data-toggle="modal" data-target="#modal" class="btn btn-default"><span class="icon-pencil"></span> <?php echo $button_edit; ?></button><button onclick="$(this).parent().parent().find('img').attr('src', '<?php echo $no_image; ?>'); $(this).parent().parent().find('input').attr('value', '');" class="btn btn-danger"><span class="icon-trash"></span> <?php echo $button_clear; ?></button></div>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-lg-9">
              <div class="image"><img src="<?php echo $icon; ?>" alt="" class="img-thumbnail" />
                <input type="hidden" name="config_logo" value="<?php echo $config_icon; ?>" /><br />
                <br />
                <div class="btn-group"><button data-toggle="modal" data-target="#modal" class="btn btn-default"><span class="icon-pencil"></span> <?php echo $button_edit; ?></button><button onclick="$(this).parent().parent().find('img').attr('src', '<?php echo $no_image; ?>'); $(this).parent().parent().find('input').attr('value', '');" class="btn btn-danger"><span class="icon-trash"></span> <?php echo $button_clear; ?></button></div>
              </div>
            </div>
        ...
        <div class="tab-pane" id="tab-ftp">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label" for="input-ftp-root"><?php echo $entry_ftp_root; ?></label>
            <div class="col-lg-9">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo $entry_ftp_status; ?></label>
            <div class="col-lg-9">
              <label class="radio-inline">
        ...
        <div class="tab-pane" id="tab-mail">
          <div class="form-group">
            <label class="col-lg-3 control-label" for="input-mail-protocol"><?php echo $entry_mail_protocol; ?></label>
            <div class="col-lg-9">
              ...
              <span class="help-block"><?php echo $help_mail_protocol; ?></span>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label" for="input-mail-parameter"><?php echo $entry_mail_parameter; ?></label>
            <div class="col-lg-9">
              ...
              <span class="help-block"><?php echo $help_mail_parameter; ?></span>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo $entry_alert_mail; ?></label>
            <div class="col-lg-9">
              <label class="radio-inline">
              ...
              <span class="help-block"><?php echo $help_alert_mail; ?></span>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo $entry_account_mail; ?></label>
            <div class="col-lg-9">
              <label class="radio-inline">
              ...
              <span class="help-block"><?php echo $help_account_mail; ?></span>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo $entry_review_mail; ?></label>
            <div class="col-lg-9">
              <label class="radio-inline">
        ...
        <div class="tab-pane" id="tab-fraud">
          <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo $entry_fraud_detection; ?></label>
            <div class="col-lg-9">
              <label class="radio-inline">
              ...
              <span class="help-block"><?php echo $help_fraud_detection; ?></span>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label" for="input-fraud-score"><?php echo $entry_fraud_score; ?></label>
            <div class="col-lg-9">
              ...
              <span class="help-block"><?php echo $help_fraud_score; ?></span>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label" for="input-fraud-status"><?php echo $entry_fraud_status; ?></label>
            <div class="col-lg-9">
              ...
              <span class="help-block"><?php echo $help_fraud_status; ?></span>
            </div>
          </div>
        </div>
        <div class="tab-pane" id="tab-server">
          <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo $entry_secure; ?></label>
            <div class="col-lg-9">
              <label class="radio-inline">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo $entry_shared; ?></label>
            <div class="col-lg-9">
              <label class="radio-inline">
              ...
              <span class="help-block"><?php echo $help_shared; ?></span>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo $entry_seo_url; ?></label>
            <div class="col-lg-9">
              <label class="radio-inline">
              ...
              <span class="help-block"><?php echo $help_seo_url; ?></span>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label" for="input-image-file-size"><?php echo $entry_image_file_size; ?></label>
            <div class="col-lg-9">
              ...
              <span class="help-block"><?php echo $help_image_file_size; ?></span>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label" for="input-file-mime-allowed"><?php echo $entry_file_mime_allowed; ?></label>
            <div class="col-lg-9">
              ...
              <span class="help-block"><?php echo $help_file_mime_allowed; ?></span>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo $entry_maintenance; ?></label>
            <div class="col-lg-9">
              <label class="radio-inline">
              ...
              <span class="help-block"><?php echo $help_maintenance; ?></span>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo $entry_password; ?></label>
            <div class="col-lg-9">
              <label class="radio-inline">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label" for="input-encryption"><?php echo $entry_encryption; ?></label>
            <div class="col-lg-9">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label" for="input-compression"><?php echo $entry_compression; ?></label>
            <div class="col-lg-9">
              ...
              <span class="help-block"><?php echo $help_compression; ?></span>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo $entry_error_display; ?></label>
            <div class="col-lg-9">
              <label class="radio-inline">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label"><?php echo $entry_error_log; ?></label>
            <div class="col-lg-9">
              <label class="radio-inline">
