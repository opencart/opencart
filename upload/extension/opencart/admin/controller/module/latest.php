	...
	public function index(): void {
		...
		if (!isset($this->request->get['module_id'])) {
			$data['breadcrumbs'][] = [
				...
				'href' => $this->url->link('extension/opencart/module/latest')
			];
		} else {
			$data['breadcrumbs'][] = [
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('extension/opencart/module/latest', 'module_id=' . $this->request->get['module_id'])
			];
		}

		if (!isset($this->request->get['module_id'])) {
			$data['save'] = $this->url->link('extension/opencart/module/latest.save');
		} else {
			$data['save'] = $this->url->link('extension/opencart/module/latest.save', 'module_id=' . $this->request->get['module_id']);
		}
