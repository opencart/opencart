...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-globalpay" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="mi mi-save">save</i></button>
  ...
  <div class="container-fluid">
    ...
    <?php } ?>
    <div class="alert alert-warning"><i class="mi mi-exclamation-circle">error</i> <?php echo $text_url_message; ?></div>
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-globalpay" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-account">
              <div class="alert alert-warning"><i class="mi mi-exclamation-circle">error</i> <?php echo $error_use_select_card; ?>
                <button type="button" class="close" data-dismiss="alert">&times;</button>
              </div>
