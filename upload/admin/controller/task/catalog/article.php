...
class Article extends \Opencart\System\Engine\Controller {
	...
	public function info(array $args = []): array {
		...
		$directory = DIR_OPENCART . 'shop/' . parse_url($store_info['url'], PHP_URL_HOST) . '/data/article/';
	...
	public function delete(array $args = []): array {
		...
		$file = DIR_OPENCART . 'shop/' . parse_url($store_info['url'], PHP_URL_HOST) . '/data/cms/article/article-' . (int)$args['article_id'] . '.json';
