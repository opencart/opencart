    ...
    <div class="box-content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <textarea name="google_talk_code" cols="40" rows="5"><?php echo $google_talk_code; ?></textarea> <span class="help-block"><?php echo $help_code; ?></span>
            <?php if ($error_code) { ?>
        ...
        <table id="module" class="table">
          ...
          <tbody>
            ...
            <tr id="module-row<?php echo $module_row; ?>">
              ...
              <td class="right"><input type="text" name="google_talk_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" class="input-mini" /></td>
...
function addModule() {	
    ...
    html += '  </select></td>';
	html += '  <td class="right"><input type="text" name="google_talk_module[' + module_row + '][sort_order]" value="" class="input-mini" /></td>';
