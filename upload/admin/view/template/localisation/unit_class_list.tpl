      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($unit_class['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $unit_class['unit_class_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $unit_class['unit_class_id']; ?>" />
                <?php } ?></td>
              <td class="left"><?php echo $unit_class['title']; ?></td>
              <td class="left"><?php echo $unit_class['unit']; ?> <span class='pozn'>(<?php echo $unit_class['product_total']; ?>)</span></td>
