...
class ControllerLocalisationLanguage extends Controller {
	...
	protected function getList() {
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($language_total) ? (($page - 1) * $this->config->get('config_admin_limit')) + 1 : 0, ((($page - 1) * $this->config->get('config_admin_limit')) > ($language_total - $this->config->get('config_admin_limit'))) ? $language_total : ((($page - 1) * $this->config->get('config_admin_limit')) + $this->config->get('config_admin_limit')), $language_total, ceil($language_total / $this->config->get('config_admin_limit')));
