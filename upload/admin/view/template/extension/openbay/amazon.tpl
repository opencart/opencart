...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <?php } else { ?>
      <div class="col-md-3 text-center">
        <div class="well"> <a href="https://account.openbaypro.com/amazon/apiRegister/" target="_BLANK"> <span class="mi-stack mi-3x"> <i class="mi mi-square-o mi-stack-2x">crop_square</i> <i class="mi mi-star mi-stack-1x">star</i> </span>
