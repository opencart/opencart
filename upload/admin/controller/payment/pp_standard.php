...
class ControllerPaymentPPStandard extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->ssl('payment/pp_standard', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->ssl('payment/pp_standard', 'token=' . $this->session->data['token'], true);
