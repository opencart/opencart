...
$_['text_secure']        = 'Do not give your PIN to anyone (including developers). If you require an extension seller, to install an extension for you, you should send them an email with the required extension package.';
