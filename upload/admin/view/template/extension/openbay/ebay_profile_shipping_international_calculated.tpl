...
<div class="well" id="international_calculated_<?php echo $key; ?>">
  ...
  <div class="row form-group">
    <div class="col-sm-3 pull-right text-right">
      <a onclick="removeShipping('international','<?php echo $key; ?>', 'calculated');" class="btn btn-danger"><i class="mi mi-minus-circle">remove circle</i> <?php echo $button_delete; ?></a>
    </div>
  </div>
</div>
<?php } ?>
