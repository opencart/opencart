...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-currency" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="mi mi-save">save</i></button>
  ...
  <div class="container-fluid">
    ...
    <?php } ?>
    <div class="alert alert-info"><i class="mi mi-info-circle">info</i> <?php echo $text_iso; ?>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
