  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="mi mi-plus">add</i></a>
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-affiliate').submit() : false;"><i class="mi mi-trash-o">delete</i></button>
      </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php if ($affiliate['approve']) { ; ?>
                    <a href="<?php echo $affiliate['approve']; ?>" data-toggle="tooltip" title="<?php echo $button_approve; ?>" class="btn btn-success"><i class="mi mi-thumbs-o-up">thumb_up</i></a>
                    <?php } else { ?>
                    <button type="button" class="btn btn-success" disabled><i class="mi mi-thumbs-o-up">thumb_up</i></button>
                    <?php } ?>
                    <?php if ($affiliate['unlock']) { ; ?>
                    <a href="<?php echo $affiliate['unlock']; ?>" data-toggle="tooltip" title="<?php echo $button_unlock; ?>" class="btn btn-warning"><i class="mi mi-unlock">lock_open</i></a>
                    <?php } else { ?>
                    <button type="button" class="btn btn-warning" disabled><i class="mi mi-unlock">lock_open</i></button>
                    <?php } ?>                   
                    <a href="<?php echo $affiliate['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="mi mi-pencil">mode_edit</i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
