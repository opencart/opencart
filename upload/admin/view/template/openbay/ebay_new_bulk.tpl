              ...
              $.ajax({
                ...
                success: function(data) {
                  ...
                  if (data.ack != 'Failure') {
                    ...
                    $('#p_row_buttons_'+data.i).prepend('<a class="btn btn-primary button-listing-view" href="<?php echo addslashes($listing_link); ?>'+data.itemid+'" target="_BLANK"><?php echo addslashes($button_view); ?></a>');
