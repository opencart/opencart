  ...
  <table class="table table-bordered table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-right"><button type="button" value="<?php echo $ip['ip']; ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-danger btn-xs"><i class="fa fa-minus-circle"></i> <?php echo $text_remove_ban_ip; ?></button></td>
      </tr>
      <?php } ?>
      <?php } else { ?>
      <tr>
