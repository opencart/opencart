...
class ModelMarketingAffiliate extends Model {
	public function addAffiliate($data) {
		$this->event->trigger('pre.admin.add.affiliate', $data);
		...
		$this->event->trigger('post.admin.add.affiliate', $affiliate_id);

		return $affiliate_id;
	}

	public function editAffiliate($affiliate_id, $data) {
		$this->event->trigger('pre.admin.edit.affiliate', $data);
		...
		$this->event->trigger('post.admin.edit.affiliate', $affiliate_id);
	}

	public function deleteAffiliate($affiliate_id) {
		$this->event->trigger('pre.admin.delete.affiliate', $affiliate_id);
		...
		$this->event->trigger('post.admin.delete.affiliate', $affiliate_id);
	}
	...
	public function approve($affiliate_id) {
		...
		if ($affiliate_info) {
			$this->event->trigger('pre.admin.approve.affiliate', $affiliate_id);
			...
			$this->event->trigger('post.admin.approve.affiliate', $affiliate_id);
		}
	}
	...
	public function addTransaction($affiliate_id, $description = '', $amount = '', $order_id = 0) {
		...
		if ($affiliate_info) {
			$this->event->trigger('pre.admin.add.affiliate.transaction', $affiliate_id);
			...
			$this->event->trigger('post.admin.add.affiliate.transaction', $affiliate_transaction_id);
	...
	public function deleteTransaction($order_id) {
		$this->event->trigger('pre.admin.delete.affiliate.transaction', $order_id);

		$this->db->query("DELETE FROM " . DB_PREFIX . "affiliate_transaction WHERE order_id = '" . (int)$order_id . "'");

		$this->event->trigger('post.admin.delete.affiliate.transaction', $order_id);
	}
