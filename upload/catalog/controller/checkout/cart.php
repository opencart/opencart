	...
	public function add() {
		...
		if ($product_info) {
			...
			if (!$json) {
				...
				$json['success'] = sprintf($this->language->get('text_success'), str_replace('&amp;', '&', $this->url->link('product/product', 'language=' . $this->config->get('config_language') . '&product_id=' . $this->request->post['product_id'])), $product_info['name'], str_replace('&amp;', '&', $this->url->link('checkout/cart', 'language=' . $this->config->get('config_language'))));
