...
class ControllerModuleSagepayDirectCards extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->ssl('module/sagepay_direct_cards', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->ssl('module/sagepay_direct_cards', 'token=' . $this->session->data['token'], true);
