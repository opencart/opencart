...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['product_option'])) {
			$data['product_options'] = $this->request->post['product_option'];
		} elseif (isset($this->request->get['product_id'])) {
			$data['product_options'] = $this->model_catalog_product->getProductOptions($this->request->get['product_id']);
		} else {
			$data['product_options'] = array();
		}
		
		foreach ($data['product_options'] as $n => $product_option) {
			if (!isset($product_option['product_option_value'])) {
				$data['product_options'][$n]['product_option_value'] = array();
			}
			if (!isset($product_option['value'])) {
				$data['product_options'][$n]['value'] = '';
			}
		}
