      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-banner" class="form-horizontal">
        ...
        <table id="images" class="table table-striped table-bordered table-hover">
          ...
          <tfoot>
            <tr>
              <td colspan="4"></td>
              <td class="text-left"><button type="button" onclick="addImage();" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_banner_add; ?></button></td>
            </tr>
          </tfoot>
        </table>
      </form>
