...
class ControllerModuleAmazonLogin extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->ssl('module/amazon_login', 'token=' . $this->session->data['token'], true),
			'separator' => ' :: '
		);

		$data['action'] = $this->url->ssl('module/amazon_login', 'token=' . $this->session->data['token'], true);
