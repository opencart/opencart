		...
		<td id="release_status">
			...
			<?php } else { ?>
				...
				<?php if ($securetrading_ws_order['void_status'] == 0) { ?>
					...
					<span class="btn btn-primary" id="img_loading_release" style="display:none;"><i class="mi mi-cog mi-spin mi-lg">settings</i></span>
				<?php } ?>
			<?php } ?>
		</td>
	</tr>
	<tr>
		...
		<td id="void_status">
			...
			<?php } elseif ($securetrading_ws_order['void_status'] == 0 && $securetrading_ws_order['release_status'] != 1 && $securetrading_ws_order['rebate_status'] != 1) { ?>
				...
				<span class="btn btn-primary" id="img_loading_void" style="display:none;"><i class="mi mi-cog mi-spin mi-lg">settings</i></span>
			<?php } else { ?>
				<span class="void_text"><?php echo $text_no; ?></span>
			<?php } ?>
		</td>
		...
		<td id="rebate_status">
			...
			<?php } else { ?>
				...
				<?php if ($securetrading_ws_order['total_released'] > 0 && $securetrading_ws_order['void_status'] == 0) { ?>
					...
					<span class="btn btn-primary" id="img_loading_rebate" style="display:none;"><i class="mi mi-cog mi-spin mi-lg">settings</i></span>
				<?php } ?>
			<?php } ?>
		</td>
	</tr>
