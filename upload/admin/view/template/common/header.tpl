...
<div id="container">
<div id="header">
  <div id="logo"><a href="<?php echo $home; ?>"><?php echo $name; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<span><?php echo $heading_title; ?></span></div>
  <?php if ($logged) { ?>
  <div id="logged"><img src="view/image/lock.png" alt="" style="position: relative; top: 3px;" />&nbsp;<?php echo $logged; ?></div>
  <?php } ?>
</div>
<?php if ($logged) { ?>
<div id="menu">
