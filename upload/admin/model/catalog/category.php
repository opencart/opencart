...
class ModelCatalogCategory extends Model {
	public function addCategory($data) {
		...
		if (isset($data['category_seo_url'])) {
			$path = $this->getCategoryFullPath($category_id);

			foreach ($data['category_seo_url'] as $store_id => $language) {
				foreach ($language as $language_id => $keyword) {
					if (!empty($keyword)) {
						$this->db->query("INSERT INTO " . DB_PREFIX . "seo_url SET store_id = '" . (int)$store_id . "', language_id = '" . (int)$language_id . "', query = 'path=" . $path . "', keyword = '" . $this->db->escape($keyword) . "', push = 'route=product/category&path=" . $path . "'");
					}
				}
			}
		}
	...
	public function getCategorySeoUrls($category_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "seo_url WHERE query = 'path=" . $path . "'");
	...
	public function editCategory($category_id, $data) {
		...
		$this->db->query("DELETE FROM `" . DB_PREFIX . "seo_url` WHERE query = 'path=" . $path . "'");
	...
	public function deleteCategory($category_id) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "seo_url WHERE query = 'path=" . $this->getCategoryFullPath($category_id) . "'");
