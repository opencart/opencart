...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['report_purchased'] = $this->url->link('report/purchased', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['report_sale'] = $this->url->link('report/sale', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['report_viewed'] = $this->url->link('report/viewed', 'token=' . $this->session->data['token'], 'SSL');
