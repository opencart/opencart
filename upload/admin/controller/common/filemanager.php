...
class ControllerCommonFileManager extends Controller {
	...
	public function directory() {
		...
		if (isset($this->request->post['directory'])) {
			$directories = glob(rtrim(DIR_IMAGE . 'data/' . $this->cleanPath($this->request->post['directory']), '/') . '/*', GLOB_ONLYDIR);
	...
	public function files() {
		...
		if (!empty($this->request->post['directory'])) {
			$directory = DIR_IMAGE . 'data/' . $this->cleanPath($this->request->post['directory']);
		} else {
	...
	public function create() {
		...
		if (isset($this->request->post['directory'])) {
			if (isset($this->request->post['name']) || $this->request->post['name']) {
				$directory = rtrim(DIR_IMAGE . 'data/' . $this->cleanPath($this->request->post['directory']), '/');
	...
	public function delete() {
		...
		if (isset($this->request->post['path'])) {
			$path = rtrim(DIR_IMAGE . 'data/' . $this->cleanPath(html_entity_decode($this->request->post['path'], ENT_QUOTES, 'UTF-8')), '/');
	...
	public function move() {
		...
		if (isset($this->request->post['from']) && isset($this->request->post['to'])) {
			$from = rtrim(DIR_IMAGE . 'data/' . $this->cleanPath(html_entity_decode($this->request->post['from'], ENT_QUOTES, 'UTF-8')), '/');
			...
			$to = rtrim(DIR_IMAGE . 'data/' . $this->cleanPath(html_entity_decode($this->request->post['to'], ENT_QUOTES, 'UTF-8')), '/');
	...
	public function copy() {
		...
		if (isset($this->request->post['path']) && isset($this->request->post['name'])) {
			...
			$old_name = rtrim(DIR_IMAGE . 'data/' . $this->cleanPath(html_entity_decode($this->request->post['path'], ENT_QUOTES, 'UTF-8')), '/');
