<ul id="nav" style="display: none;">
  ...
  <li id="extension"><a class="top"><?php echo $text_extension; ?></a>
    <ul>
      ...
      <!--
      <li><a class="parent"><?php echo $text_google; ?></a>
        <ul>
          <li><a href="<?php echo $google_optimizer; ?>"><?php echo $text_google_optimizer; ?></a></li>
        </ul>
      </li>
      //-->
    </ul>
  ...
  <li id="customers"><a class="top"><?php echo $text_customers; ?></a>
    <ul>
      ...
      <li><a href="<?php echo $send_mail; ?>"><?php echo $text_send_mail; ?></a></li>
    </ul>
  </li>
