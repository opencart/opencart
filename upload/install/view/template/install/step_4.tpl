...
<div class="container">
  ...
  <div class="modules">
    ...
    <div class="row">
      <div class="col-sm-12 text-center"><a href="http://www.opencart.com/index.php?route=extension/extension&utm_source=opencart_install&utm_medium=store_link&utm_campaign=opencart_install" target="_BLANK" class="btn btn-default"><?php echo $text_store; ?></a></div>
    </div>
  </div>
  <div class="mailing-list">
    <div class="row">
      <div class="col-sm-12"><img src="view/image/icon-mail.png">
        ...
        <a href="http://newsletter.opencart.com/h/r/B660EBBE4980C85C" target="_BLANK" class="btn btn-secondary"><?php echo $button_join; ?></a></div>
    </div>
  </div>
...
function searchLanguages() {
	$.ajax({
		url: 'index.php?route=install/step_4/language',
		type: 'post',
		data: {
