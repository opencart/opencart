<?php
class ControllerAffiliateAdd extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$this->load->language('account/affiliate_add');
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$affiliate_id = $this->model_account_customer->addAffiliate($this->request->post);
