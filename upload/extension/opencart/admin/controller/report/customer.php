...
class Customer extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/opencart/report/customer')
		];

		$data['save'] = $this->url->link('extension/opencart/report/customer.save');
	...
	public function getReport(): string {
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'url'   => $this->url->link('extension/opencart/report/customer.report', 'code=customer' . $url . '&page={page}')
		]);
