...
function country(element, index, zone_id) {
  if (element.value != '') {
		$.ajax({
			...
			dataType: 'json',
			beforeSend: function() {
				$('select[name=\'address[' + index + '][country_id]\']').after(' <i class="fa-spinner fa-spin"></i>');
			},
			complete: function() {
				$('.fa-spinner').remove();
			},			
...
$('#button-transaction').on('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			$('#button-transaction i').replaceWith('<i class="fa-spinner fa-spin"></i>');
...
$('#button-reward').on('click', function() {	
	$.ajax({
		...
		beforeSend: function() {
			$('#button-reward i').replaceWith('<i class="fa-spinner fa-spin"></i>');
...
$('body').delegate('.button-ban-add', 'click', function() {
	...
	$.ajax({
		...
		beforeSend: function() {
			$(element).find('i').replaceWith('<i class="fa-spinner fa-spin"></i>');
		},
		complete: function() {
