...
<div id="<?php echo $type; ?>-new" style="display: none;">
  <table class="form">
    ...
    <tr>
      ...
      <td><select name="country_id" class="large-field" onclick="$('#<?php echo $type; ?>-address select[name=\'zone_id\']').load('index.php?route=checkout/address/zone&country_id=' + this.value);">
