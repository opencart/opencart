...
class WeightClass extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('localisation/weight_class', $url)
		];

		$data['add'] = $this->url->link('localisation/weight_class.form', $url);
		$data['delete'] = $this->url->link('localisation/weight_class.delete');
	...
	protected function getList(): string {
		...
		$data['action'] = $this->url->link('localisation/weight_class.list', $url);
		...
		foreach ($results as $result) {
			$data['weight_classes'][] = [
				...
				'unit'            => $result['unit'],
				'value'           => $result['value'],
				'edit'            => $this->url->link('localisation/weight_class.form', 'weight_class_id=' . $result['weight_class_id'] . $url)
			];
		}
		...
		$data['sort_title'] = $this->url->link('localisation/weight_class.list', 'sort=title' . $url);
		$data['sort_unit'] = $this->url->link('localisation/weight_class.list', 'sort=unit' . $url);
		$data['sort_value'] = $this->url->link('localisation/weight_class.list', 'sort=value' . $url);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('localisation/weight_class.list', $url . '&page={page}')
		]);
	...
	public function form(): void {
		...
		$data['save'] = $this->url->link('localisation/weight_class.save');
		$data['back'] = $this->url->link('localisation/weight_class', $url);
