...
class ModelMarketingMarketing extends Model {
	public function addMarketing($data) {
		$this->event->trigger('pre.admin.add.marketing', $data);
		...
		$this->event->trigger('post.admin.add.marketing', $marketing_id);

		return $marketing_id;
	}

	public function editMarketing($marketing_id, $data) {
		$this->event->trigger('pre.admin.edit.marketing', $data);
		...
		$this->event->trigger('post.admin.edit.marketing', $marketing_id);
	}

	public function deleteMarketing($marketing_id) {
		$this->event->trigger('pre.admin.delete.marketing', $marketing_id);

		$this->db->query("DELETE FROM " . DB_PREFIX . "marketing WHERE marketing_id = '" . (int)$marketing_id . "'");

		$this->event->trigger('post.admin.delete.marketing', $marketing_id);
	}
