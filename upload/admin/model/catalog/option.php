...
class ModelCatalogOption extends Model {
	public function addOption($data) {
		$this->event->trigger('pre.option.add', $data);
		...
		$this->event->trigger('post.option.add', $option_id);

		return $option_id;
	}

	public function editOption($option_id, $data) {
		$this->event->trigger('pre.option.edit', $data);
		...
		$this->event->trigger('post.option.edit', $option_id);
	}

	public function deleteOption($option_id) {
		$this->event->trigger('pre.option.delete', $option_id);
		...
		$this->event->trigger('post.option.delete', $option_id);
	}
