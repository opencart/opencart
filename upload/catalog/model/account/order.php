...
class Order extends \Opencart\System\Engine\Model {
    ...
    ";
		...
		return [
			...
			'payment_method'          => $order_row['payment_method'] ? json_decode($order_row['payment_method'], true) : '',
			...
			'shipping_method'         => $order_row['shipping_method'] ? json_decode($order_row['shipping_method'], true) : '',
