...
<div class="row"> <?php echo $column_left; ?>
  <div class="span9"><?php echo $content_top; ?>
    ...
    <div class="form-group">
      <label class="col-lg-2 control-label" for="input-generator"><?php echo $entry_generator; ?><span class="help-block"><?php echo $help_generator; ?></span></label>
      <div class="col-lg-10">
        <input type="text" name="product" value="" placeholder="<?php echo $entry_generator; ?>" id="input-generator" />
      </div>
    </div>
    <div class="form-group">
      <label class="col-lg-2 control-label" for="input-link"><?php echo $entry_link; ?></label>
      <div class="col-lg-10">
