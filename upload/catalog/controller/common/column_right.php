		...
		foreach ($extensions as $extension) {
			...
			if ($modules) {
				foreach ($modules as $module) {
					if (((isset($module['layout_id']) && $module['layout_id'] == $layout_id) || (isset($module['layouts']) && in_array($layout_id, $module['layouts']))) && $module['position'] == 'column_right' && $module['status']) {
						$module_data[] = array(
							'code'       => $extension['code'],
							'setting'    => $module,
