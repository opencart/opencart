...
$_['help_void_status']                    = 'Set the order status to voided order is edited before being given a new status.';
$_['help_fraud_status']                   = 'Set the order status when a customer is suspected of trying to alter the order payment details or use a coupon or reward points that have already been used.';
