...
class CustomerOrder extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('marketplace/opencart/extension', 'type=report')
		];

		$data['breadcrumbs'][] = [
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('extension/opencart/report/customer_order')
		];

		$data['save'] = $this->url->link('extension/opencart/report/customer_order.save');
	...
	public function getReport(): string {
		...
		foreach ($results as $result) {
			$data['customers'][] = [
				...
				'edit'           => $this->url->link('customer/customer.form', 'customer_id=' . $result['customer_id'])
			];
		}
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination'),
			'url'   => $this->url->link('extension/opencart/report/customer_order.report', 'code=customer_order' . $url . '&page={page}')
		]);
