...
class AttributeGroup extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('catalog/attribute_group', $url)
		];

		$data['add'] = $this->url->link('catalog/attribute_group.form', $url);
		$data['delete'] = $this->url->link('catalog/attribute_group.delete');
	...
	protected function getList(): string {
		...
		$data['action'] = $this->url->link('catalog/attribute_group.list', $url);
		...
		foreach ($results as $result) {
			$data['attribute_groups'][] = [
				...
				'edit'               => $this->url->link('catalog/attribute_group.form', 'attribute_group_id=' . $result['attribute_group_id'] . $url)
			];
		}
		...
		$data['sort_name'] = $this->url->link('catalog/attribute_group.list', 'sort=agd.name' . $url);
		$data['sort_sort_order'] = $this->url->link('catalog/attribute_group.list', 'sort=ag.sort_order' . $url);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('catalog/attribute_group.list', $url . '&page={page}')
		]);
	...
	public function form(): void {
		...
		$data['save'] = $this->url->link('catalog/attribute_group.save');
		$data['back'] = $this->url->link('catalog/attribute_group', $url);
