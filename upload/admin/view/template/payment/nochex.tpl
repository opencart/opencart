...
<div id="content">
  ...
  <div class="panel">
    <div class="panel-heading">
      ...
      <div class="buttons">
        <button type="submit" form="form-nochex" class="btn btn-primary"><i class="icon-ok"></i> <?php echo $button_save; ?></button>
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-nochex" class="form-horizontal">
      ...
      <div class="form-group">
        <div class="col-lg-2 control-label"><?php echo $entry_template; ?></div>
        <div class="col-lg-10">
