...
describe('case / when / endcase', () => {
    ...
    test('dotted path with missing intermediate key produces no output', () => {
        ...
        expect(curlytag.parse(tpl, { user: {} })).toBe('');
    });
