  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-bluepay-redirect" class="btn btn-primary"><i class="mi mi-check-circle">check_circle</i> <?php echo $button_save; ?></button>
        <a href="<?php echo $cancel; ?>" class="btn btn-default"><i class="mi mi-reply">reply</i> <?php echo $button_cancel; ?></a></div>
