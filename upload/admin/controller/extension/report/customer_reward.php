...
class ControllerExtensionReportCustomerReward extends Controller {
	...
	public function info() {
		...
		$data['breadcrumbs'][] = array(
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('report/customer_reward', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);
		...
		$pagination->url = $this->url->link('report/customer_reward', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
