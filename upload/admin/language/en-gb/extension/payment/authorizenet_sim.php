...
$_['entry_sig_key']		= 'Signature Key (Hex String)';
...
// Help
$_['help_callback']		= 'Please login and set this at <a href="https://secure.authorize.net" target="_blank" class="txtLink">https://secure.authorize.net</a> sandbox.authorize.net for test accounts.';
$_['help_sig_key']		= 'The signature key allows you to send a transaction to authorize.net, and authenticate that a transaction response is securely received from Authorize.Net.Please login and set this at <a href="https://secure.authorize.net" target="_blank" class="txtLink">https://secure.authorize.net</a>.  sandbox.authorize.net for test accounts.';
...
$_['error_sig_key']		= 'Signature Key Required!';
