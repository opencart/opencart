...
$_['text_server']     = '1. Check your server is set-up correctly';
$_['text_steps']      = '2. Upgrade Progress';
...
$_['text_admin']      = 'Load the admin page & press <code>Ctrl+F5</code> twice to force the browser to update the css changes.';
$_['text_user']       = 'Goto <code>Admin -> Users -> User Groups</code> and Edit the Top Adminstrator group. Check All boxes.';
$_['text_setting']    = 'Goto Admin and Edit the main System Settings. Update all fields and click save, even if nothing changed.';
$_['text_store']      = 'Load the store front & press <code>Ctrl+F5</code> twice to force the browser to update the css changes.';
