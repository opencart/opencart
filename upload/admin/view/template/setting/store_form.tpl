      ...
      <div class="tab-content">
        <div class="tab-pane active" id="tab-general">
          <div class="form-group required">
            <label class="col-lg-3 control-label" for="input-url"><?php echo $entry_url; ?> <span class="help-block"><?php echo $help_url; ?></span></label>
            <div class="col-lg-9">
              <input type="text" name="config_url" value="<?php echo $config_url; ?>" placeholder="<?php echo $entry_url; ?>" id="input-url" class="xxlarge" />
              <?php if ($error_url) { ?>
              <span class="text-error"><?php echo $error_url; ?></span>
              <?php } ?>
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label" for="input-ssl"><?php echo $entry_ssl; ?> <span class="help-block"><?php echo $help_ssl; ?></span></label>
            <div class="col-lg-9">
        ...
        <div class="tab-pane" id="tab-option">
          ...
          <fieldset>
            ...
            <div class="form-group">
              <div class="col-lg-3 control-label"><?php echo $entry_cart_weight; ?></div>
              <div class="col-lg-9">
                <label class="radio inline">
        ...
        <div class="tab-pane" id="tab-image">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label" for="input-icon"><?php echo $entry_icon; ?> <span class="help-block"><?php echo $help_icon; ?></span></label>
            <div class="col-lg-9">
          ...
          <div class="form-group required">
            <label class="col-lg-3 control-label" for="input-image-related-width"><?php echo $entry_image_related; ?></label>
            <div class="col-lg-9">
          ...
          <div class="form-group required">
            <label class="col-lg-3 control-label" for="input-image-compare-width"><?php echo $entry_image_compare; ?></label>
            <div class="col-lg-9">
          ...
          <div class="form-group required">
            <label class="col-lg-3 control-label" for="input-image-wishlist-width"><?php echo $entry_image_wishlist; ?></label>
            <div class="col-lg-9">
          ...
          <div class="form-group required">
            <label class="col-lg-3 control-label" for="input-image-cart-width"><?php echo $entry_image_cart; ?></label>
            <div class="col-lg-9">
