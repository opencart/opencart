...
class ControllerSaleRecurring extends Controller {
	...
	public function info() {
		...
		if ($order_recurring_info) {
			...
			$data['text_cancel_payment'] = $this->language->get('text_cancel_payment');
