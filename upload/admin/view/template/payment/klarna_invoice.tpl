  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-klarna-invoice" class="btn btn-primary"><i class="fa-ok"></i> <?php echo $button_save; ?></button>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-klarna-invoice" class="form-horizontal">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="tab-log">
            ...
            <div class="text-right"><a href="<?php echo $clear; ?>" class="btn btn-danger"><i class="fa-eraser"></i> <?php echo $button_clear ?></a></div>
          </div>
        </div>
      </form>
    </div>
