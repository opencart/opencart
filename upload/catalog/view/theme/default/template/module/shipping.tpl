...
<div class="panel panel-default">
  <div class="panel-heading">
    <h4 class="panel-title"><a href="#collapse-shipping" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"><?php echo $heading_title; ?> <i class="icon-caret-down"></i></a></h4>
  </div>
...
$('#button-quote').on('click', function() {
	$.ajax({
		url: 'index.php?route=module/shipping/quote',
		type: 'post',
...
$(document).delegate('#button-shipping', 'click', function() {
	$.ajax({
		url: 'index.php?route=module/shipping/shipping',
		type: 'post',
