...
class ControllerUserUserGroup extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validateForm())) {
			...
			$this->redirect($this->url->https('user/user_group' . $url));
		}
	...
	private function getList() {
		...
		if (isset($this->request->get['order'])) {
  		...
  		$this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => $this->url->https('user/user_group' . $url),
       		'text'      => $this->language->get('heading_title'),
      		'separator' => ' :: '
   		);
							
		$this->data['insert'] = $this->url->https('user/user_group/insert' . $url);
		...
		foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->https('user/user_group/update&user_group_id=' . $result['user_group_id'] . $url)
			);		
		...
		$this->data['sort_name'] = $this->url->https('user/user_group&sort=name' . $url);
		...
		$pagination->url = $this->url->https('user/user_group' . $url . '&page=%s');
	...
	private function getForm() {
		...
		if (!isset($this->request->get['user_group_id'])) {
			$this->data['action'] = $this->url->https('user/user_group/insert' . $url);
		} else {
			$this->data['action'] = $this->url->https('user/user_group/update&user_group_id=' . $this->request->get['user_group_id'] . $url);
		}
		  
    	$this->data['cancel'] = $this->url->https('user/user_group' . $url);
