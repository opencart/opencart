...
class ModelCatalogRecurring extends Model {
	public function addRecurring($data) {
		$this->event->trigger('pre.recurring.add', $data);
		...
		$this->event->trigger('post.recurring.add', $recurring_id);

		return $recurring_id;
	}

	public function editRecurring($recurring_id, $data) {
		$this->event->trigger('pre.recurring.edit', $data);
		...
		$this->event->trigger('post.recurring.edit', $recurring_id);
	}
	...
	public function deleteRecurring($recurring_id) {
		$this->event->trigger('pre.recurring.delete', $recurring_id);
		...
		$this->event->trigger('post.recurring.delete', $recurring_id);
	}
