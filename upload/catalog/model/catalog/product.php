...
class ModelCatalogProduct extends Model {
	...
	public function getProductsByTag($tag, $category_id = 0, $sort = 'pd.name', $order = 'ASC', $start = 0, $limit = 20) {
		if ($tag) {
	...
	public function getProductsByKeyword($keyword, $category_id = 0, $description = FALSE, $model = FALSE, $sort = 'pd.name', $order = 'ASC', $start = 0, $limit = 20) {
		if ($keyword) {
