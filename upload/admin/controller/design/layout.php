	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['layouts'][] = array(
				...
				'name'      => $result['name'],
				'edit'      => $this->url->link('design/layout/update', 'token=' . $this->session->data['token'] . '&layout_id=' . $result['layout_id'] . $url, 'SSL')
			);
		}
