...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><button class="btn btn-primary" data-toggle="tooltip" form="form-google-base" title="<?php echo $button_save; ?>" type="submit"><i class="fa fa-save"></i></button> <a class="btn btn-default" data-toggle="tooltip" href="<?php echo $cancel; ?>" title="<?php echo $button_cancel; ?>"><i class="fa fa-reply"></i></a></div>
  ...
  <div class="container-fluid">
    ...
    <div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> <?php echo $error_warning; ?> <button class="close" data-dismiss="alert" type="button">&times;</button></div>
    <?php } ?>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <div class="form-group">
                ...
                <div class="col-sm-10"><select class="form-control" id="input-order-status" name="ip_order_status_id">
                            ...
                            <div class="col-sm-10">
                              <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                  <button class="btn btn-primary" data-loading-text="<?php echo $text_loading; ?>" id="button-ip-add" type="button">
                                    <?php echo $button_ip_add; ?>
                                  </button>
                                </span>
                              </div>
                            </div>
