...
class ControllerCommonFooterTop extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/common/footer_top.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/common/footer_top.tpl', $data);
		} else {
			return $this->load->view('default/template/common/footer_top.tpl', $data);
		}
	}
}