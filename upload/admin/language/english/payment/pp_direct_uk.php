<?php
// Heading
$_['heading_title']      = 'PayPal Direct (UK)';

// Text 
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified PayPal Direct (UK) account details!';
$_['text_pp_direct_uk']  = '<a onclick="window.open(\'https://www.paypal.com/uk/mrb/pal=W9TBB5DTD6QJW\');"><img src="view/image/payment/paypal.png" alt="PayPal Direct (UK)" title="PayPal Direct (UK)" style="border: 1px solid #EEEEEE;" /></a>';
...
// Error
$_['error_permission']   = 'Warning: You do not have permission to modify payment PayPal Direct (UK)!';
