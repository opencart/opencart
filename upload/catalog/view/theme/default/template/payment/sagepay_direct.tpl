<div class="form-horizontal">
  <fieldset id="payment">
    ...
    <div class="control-group required">
      <label class="control-label" for="input-cc-start-date"><?php echo $entry_cc_start_date; ?></label>
      <div class="controls">
    ...
    <div class="control-group required">
      <label class="control-label" for="input-cc-cvv2"><?php echo $entry_cc_cvv2; ?></label>
      <div class="controls">
        <input type="text" name="cc_cvv2" value="" placeholder="<?php echo $entry_cc_cvv2; ?>" id="input-cc-cvv2" class="input-small" />
      </div>
    </div>
    <div class="control-group">
      <label class="control-label" for="input-cc-issue"><?php echo $entry_cc_issue; ?></label>
      <div class="controls">
