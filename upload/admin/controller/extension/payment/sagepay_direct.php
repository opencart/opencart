...
class ControllerExtensionPaymentSagepayDirect extends Controller {
	...
	public function index() {
		...
		$data['payment_sagepay_direct_cron_job_url'] = HTTPS_CATALOG . 'index.php?route=extension/payment/sagepay_direct/cron&token=' . $data['payment_sagepay_direct_cron_job_token'];
