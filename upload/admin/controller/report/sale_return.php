...
class ControllerReportSaleReturn extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->ssl('report/sale_return', 'token=' . $this->session->data['token'] . $url, true)
		);
		...
		$pagination->url = $this->url->ssl('report/sale_return', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
