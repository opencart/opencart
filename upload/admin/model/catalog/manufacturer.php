...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
		$this->event->trigger('pre.manufacturer.add', $data);
		...
		$this->event->trigger('post.manufacturer.add', $manufacturer_id);

		return $manufacturer_id;
	}

	public function editManufacturer($manufacturer_id, $data) {
		$this->event->trigger('pre.manufacturer.edit', $data);
		...
		$this->event->trigger('post.manufacturer.edit');
	}

	public function deleteManufacturer($manufacturer_id) {
		$this->event->trigger('pre.manufacturer.delete', $manufacturer_id);
		...
		$this->event->trigger('post.manufacturer.delete', $manufacturer_id);
	}
