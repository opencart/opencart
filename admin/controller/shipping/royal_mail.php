	...
	public function index() {   
		...
		$this->data['error_warning'] = @$this->error['warning'];
  		...
  		$this->document->breadcrumbs = array();
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => $this->url->https('shipping/royal_mail'),
       		'text'      => $this->language->get('heading_title'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = $this->url->https('shipping/royal_mail');
		...
		if (isset($this->request->post['royal_mail_cost'])) {
			$this->data['royal_mail_cost'] = $this->request->post['royal_mail_cost'];
		} else {
			$this->data['royal_mail_cost'] = $this->config->get('royal_mail_cost');
		}
