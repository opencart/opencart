...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="buttons"> <a href="<?php echo $back ?>" class="button left"><span><?php echo $text_back ?></span></a> <a class="button right" id="confirm-button"><span><?php echo $text_confirm ?></span></a> </div>
