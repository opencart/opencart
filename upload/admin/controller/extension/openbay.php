...
class ControllerExtensionOpenbay extends Controller {
	public function index() {
		...
		$markets = array('openbay', 'amazon', 'amazonus');
	...
	public function manage() {
		...
		$data['breadcrumbs'][] = array(
			...
			'text' => $this->language->get('lang_text_manage'),
		);
	...
	public function faqGet() {
		...
		$data['faqbtn'] = $this->language->get('lang_btn_faq');
	...
	public function orderList() {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->link('extension/openbay/manage', 'token=' . $this->session->data['token'], 'SSL'),
			'text' => $data['lang_title_order_update'],
		);
	...
	public function linkStatus() {
		...
		$data = $this->load->language('extension/default');
		...
		$this->response->setOutput($this->load->view('openbay/openbay_links.tpl', $data));
	}
