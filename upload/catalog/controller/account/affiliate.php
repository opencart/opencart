...
class Affiliate extends \Opencart\System\Engine\Controller {
	...
	public function save(): void {
		...
		if (!$json) {
			...
			} elseif ($this->request->post['payment_method'] == 'paypal' && ((oc_strlen($this->request->post['paypal']) > 96) || !filter_var(oc_punycode($this->request->post['paypal']), FILTER_VALIDATE_EMAIL))) {
