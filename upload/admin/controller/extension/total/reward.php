...
class ControllerExtensionTotalReward extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/total/reward', 'user_token=' . $this->session->data['user_token'])
		);

		$data['action'] = $this->url->link('extension/total/reward', 'user_token=' . $this->session->data['user_token']);
