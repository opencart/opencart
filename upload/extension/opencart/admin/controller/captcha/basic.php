...
class Basic extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('marketplace/extension', 'type=captcha')
		];

		$data['breadcrumbs'][] = [
			'text' => $this->language->get('heading_title'),
			'href' => $this->url->link('extension/opencart/captcha/basic')
		];

		$data['save'] = $this->url->link('extension/opencart/captcha/basic.save');
		$data['back'] = $this->url->link('marketplace/extension', 'type=captcha');
