  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="mi mi-list">view_list</i> <?php echo $text_fulfillment_list; ?></h3>
      </div>
              ...
              <?php } else { ?>
                <?php foreach ($fulfillments as $fulfillment) { ?>
                  <tr>
                    ...
                    <td class="text-right"><a href="<?php echo $fulfillment['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="mi mi-pencil">mode_edit</i></a></td>
                  </tr>
                <?php } ?>
              <?php } ?>
            </tbody>
