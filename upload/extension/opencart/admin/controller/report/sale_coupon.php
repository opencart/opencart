...
class SaleCoupon extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/opencart/report/sale_coupon')
		];

		$data['save'] = $this->url->link('extension/opencart/report/sale_coupon.save');
	...
	public function getReport(): string {
		...
		foreach ($results as $result) {
			$data['coupons'][] = [
				...
				'edit'   => $this->url->link('marketing/coupon.edit', 'coupon_id=' . $result['coupon_id'])
			];
		}
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination'),
			'url'   => $this->url->link('extension/opencart/report/sale_coupon.report', 'code=sale_coupon' . $url . '&page={page}')
		]);
