    ...
    <div class="span9">
        <div id="content">
            ...
            <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                <table class="form">
                  <tr>
                    <td><span class="text-error">*</span> <?php echo $entry_to_name; ?></td>
                  ...
                  <tr>
                    <td><span class="text-error">*</span> <?php echo $entry_to_email; ?></td>
                  ...
                  <tr>
                    <td><span class="text-error">*</span> <?php echo $entry_from_name; ?></td>
                  ...
                  <tr>
                    <td><span class="text-error">*</span> <?php echo $entry_from_email; ?></td>
                  ...
                  <tr>
                    <td valign="top"><span class="text-error">*</span> <?php echo $entry_theme; ?></td>
                    <td><?php foreach ($voucher_themes as $voucher_theme) { ?>
                      <?php if ($voucher_theme['voucher_theme_id'] == $voucher_theme_id) { ?>

                        <label class="radio" for="voucher-<?php echo $voucher_theme['voucher_theme_id']; ?>">
                ...
                <tr>
                    <td><span class="text-error">*</span> <?php echo $entry_amount; ?></td>
