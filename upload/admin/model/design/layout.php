...
class ModelDesignLayout extends Model {
	public function addLayout($data) {
		$this->event->trigger('pre.layout.add', $data);
		...
		$this->event->trigger('post.layout.add', $layout_id);

		return $layout_id;
	}

	public function editLayout($layout_id, $data) {
		$this->event->trigger('pre.layout.edit', $data);
		...
		$this->event->trigger('post.layout.edit', $layout_id);
	}

	public function deleteLayout($layout_id) {
		$this->event->trigger('pre.layout.delete', $layout_id);
		...
		$this->event->trigger('post.layout.delete', $layout_id);
	}
