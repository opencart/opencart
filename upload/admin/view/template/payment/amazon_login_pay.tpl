...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="alert alert-info">
            <!--<form method="POST" target="_blank" action="https://sellercentral.amazon.com/hz/me/sp/redirect">-->
            <form method="POST" id="registration-form" target="_blank" action="https://sellercentral-europe.amazon.com/gp/on-board/workflow/Registration/login.html">
                ...
                <input type="hidden" value="https://www.example.com/SandboxMerchatIPN" name="sandboxMerchantIPNURL">
                <input type="hidden" value="https://www.example.com/SandboxIntegratorIPN" name="sandboxIntegratorIPNURL">
                <input type="hidden" value="https://www.example.com/ProductionMerchatIPN" name="productionMerchantIPNURL">
                <input type="hidden" value="https://www.example.com/ProductionIntegratorIPN" name="productionIntegratorIPNURL">
                <button type="button" class="btn btn-link" id="sign-up">Sign-up to Login and Pay with Amazon</button>
                <button type="button" class="close" data-dismiss="alert">&times;</button>
            </form>            
        </div>
    ...
    <script type="text/javascript">
        $('#sign-up').on('click', function() {
            if ($('input[name=\'amazon_login_pay_merchant_id\']').val() === '') {
                ...
                $('input[name=\'amazon_login_pay_merchant_id\']').after('<div class="text-danger">Merchant ID is required for sign-up!</div>');
            } else {
