...
class ModelSettingStore extends Model {
	public function addStore($data) {
		$this->event->trigger('pre.admin.add.store', $data);
		...
		$this->event->trigger('post.admin.add.store', $store_id);

		return $store_id;
	}

	public function editStore($store_id, $data) {
		$this->event->trigger('pre.admin.edit.store', $data);
		...
		$this->event->trigger('post.admin.edit.store', $store_id);
	}

	public function deleteStore($store_id) {
		$this->event->trigger('pre.admin.delete.store', $store_id);
		...
		$this->event->trigger('post.admin.delete.store', $store_id);
	}
