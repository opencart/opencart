...
class ControllerApiCustomer extends Controller {
	public function index() {
		...
		if (!isset($this->session->data['api_id'])) {
			...
			if ($store_info) {
				$config_customer_group_display = $store_info['config_customer_group_display'];
			} else {
				$config_customer_group_display = $this->config->get('config_customer_group_display');
			}
			
			if (is_array($config_customer_group_display) && in_array($this->request->post['customer_group_id'], $config_customer_group_display)) {
