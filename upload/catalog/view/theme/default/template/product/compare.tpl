...
<?php if ($products) { ?>
    ...
    <table class="table table-bordered square">
        ...
        <tbody>
            ...
            <tr>
                ...
                <?php foreach ($products as $product) { ?>
                <td>
                    <img src="catalog/view/theme/default/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" />
    ...
    <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td>
            <input class="btn btn-primary" type="button" value="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" />
            <a class="btn btn-danger" href="<?php echo $product['remove']; ?>"><?php echo $button_remove; ?></a>
        </td>
        <?php } ?>
    </tr>
</table>
