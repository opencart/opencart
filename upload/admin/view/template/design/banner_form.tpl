        ...
        <tbody>
          ...
          <tr id="image-row<?php echo $image_row; ?>">
            ...
            <td class="text-left"><?php if ($banner_image['thumb']) { ?>
              <a href="" id="thumb-image<?php echo $image_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $banner_image['thumb']; ?>" alt="" title="" /></a>
              <?php } else { ?>
...
function addImage() {
	...
	html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '" data-toggle="image" class="img-thumbnail"><i class="fa fa-camera fa-5x"></i></a><input type="hidden" name="banner_image[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';
