        ...
        <div class="content">
            ...
            <?php } else { ?>
                    ...
                    <table class="list" style="width: 650px">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="left"><?php echo $user_plan['merchant_id'] ?> [ <a href="<?php echo $server ?>account/changeSellerId/?token=<?php echo $token ?>" target="_blank"><?php echo $text_change_merchantid; ?></a> ]</td>
                            </tr>
                            <tr>
                ...
                <div id="changePlan-div">    
                    ...
                    <?php if ($token): ?>
                        <a href="<?php echo $server ?>account/changePlan/?token=<?php echo $token ?>" class="button" target="_blank"><span><?php echo $text_change_plan ?></span></a>
                    <?php endif; ?>
                </div>
            <?php } ?>
        </div>
