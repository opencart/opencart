...
class ModelExtensionOpenBayAmazon extends Model {
	public function install() {
		...
		$this->model_extension_event->addEvent('openbay_amazon_add_order', 'catalog/model/checkout/order/addOrderHistory/before', 'extension/openbay/amazon/eventAddOrderHistory');
