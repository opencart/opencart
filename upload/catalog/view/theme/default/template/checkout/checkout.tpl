...
$(document).on('change', 'input[name=\'account\']', function() {
    ...
    if ($('#collapse-shipping-address').parent().find('.panel-heading .panel-title > *').is('a')) {
        if (this.value == 'register') {
        ...
        if (this.value == 'register') {
            $('#collapse-shipping-address').parent().find('.panel-heading .panel-title').html('<?php echo $text_checkout_account; ?>');
        } else {
            $('#collapse-shipping-address').parent().find('.panel-heading .panel-title').html('<?php echo $text_checkout_shipping_address; ?>');
        }
    }
});
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                if (json['error']['warning']) {
                    ...
                    $('#collapse-shipping-address .panel-body').prepend('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error']['warning'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
                }
                ...
                var payment_address = $('#shipping-address input[name=\'payment_address\']:checked').prop('value');
                    ...
                    $.ajax({
                        ...
                        success: function(html) {
                            ...
                            $.ajax({
                                ...
                                success: function(html) {
                                    $('#collapse-payment-address .panel-body').html(html);
                                    $('#collapse-payment-address').parent().find('.panel-heading .panel-title').html('<a href="#collapse-shipping-address" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle"><?php echo $text_checkout_payment_address; ?> <i class="fa fa-caret-down"></i></a>');
                                },
                                error: function(xhr, ajaxOptions, thrownError) {
                                    alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
                                }
        ...
        success: function(json) {
            ...
            $.ajax({
                ...
                success: function(html) {
                    ...
                    var selectedVal = $('#collapse-shipping-address select[name="address_id"] > option:selected').val();
                    $('#collapse-payment-address select[name="address_id"] > option[value="' + selectedVal + '"]').prop("selected", true);
                },
                error: function(xhr, ajaxOptions, thrownError) {
                    alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
                }
...
$(document).delegate('#button-guest', 'click', function() {
    $.ajax({
        ...
        data: $('#collapse-shipping-address input[type=\'text\'], #collapse-shipping-address input[type=\'date\'], #collapse-shipping-address input[type=\'datetime-local\'], #collapse-shipping-address input[type=\'time\'], #collapse-shipping-address input[type=\'checkbox\']:checked, #collapse-shipping-address input[type=\'radio\']:checked, #collapse-shipping-address input[type=\'hidden\'], #collapse-shipping-address textarea, #collapse-shipping-address select'),
        dataType: 'json',
        beforeSend: function() {
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                <?php } ?>*/
                <?php if ($shipping_required) { ?>
                var payment_address = $('#collapse-shipping-address input[name=\'payment_address\']:checked').prop('value');
                ...
                if (payment_address) {
                    ...
                    $.ajax({
                        ...
                        success: function(html) {
                            ...
                            //$('#collapse-shipping-address').parent().find('.panel-heading .panel-title').html('<a href="#collapse-payment-address" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle"><?php echo $text_checkout_shipping_address; ?> <i class="fa fa-caret-down"></i></a>');
            ...
            if (json['redirect']) {
                ...
                $.ajax({
                    ...
                    success: function(html) {
                        ...
                        $('#collapse-payment-method').parent().find('.panel-heading .panel-title').html('<a href="#collapse-payment-method" data-toggle="collapse" data-parent="#accordion" class="accordion-toggle"><?php echo $text_checkout_payment_method; ?> <i class="fa fa-caret-down"></i>');
