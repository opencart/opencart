...
class XAlertWarning extends XAlert {
    template = '<div class="alert alert-warning alert-dismissible"><i class="fa-solid fa-circle-exclamation"></i> ' + this.innerHTML + ' <button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>';
}

customElements.define('x-alert-warning', XAlertWarning);

class XAlertInfo extends XAlert {
    template = '<div class="alert alert-info alert-dismissible"><i class="fa-solid fa-info-circle"></i> ' + this.innerHTML + ' <button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>';
}
