  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-loadoffers" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary"><i class="fa fa-save"></i></button>
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-loadoffers" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="loadoffers_text_field" id="input-status" class="form-control">
                <?php if ($loadoffers_text_field) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="loadoffers_status" id="input-status" class="form-control">
                <?php if ($loadoffers_status) { ?>
