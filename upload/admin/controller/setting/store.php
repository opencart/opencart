...
class ControllerSettingStore extends Controller {
	...
	public function getForm() { 
		...
		} elseif (isset($store_info['config_catalog_desc_limit'])) {
			$this->data['config_catalog_desc_limit'] = $store_info['config_catalog_desc_limit'];	
		} else {
			$this->data['config_catalog_desc_limit'] = '100';
		}		
	...
	protected function validateForm() {
		...
		if (!$this->request->post['config_catalog_desc_limit']) {
			$this->error['catalog_desc_limit'] = $this->language->get('error_desc_limit');
		}
