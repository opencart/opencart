...
class Sale extends \Opencart\System\Engine\Model {
	...
	public function getTotalOrdersByCountry(): int {
	...
	public function getTotalOrdersByDay(): int {
		$implode = [];
	...
	public function getTotalOrdersByWeek(): int {
		$implode = [];
	...
	public function getTotalOrdersByMonth(): int {
		$implode = [];
	...
	public function getTotalOrdersByYear(): int {
		$implode = [];
	...
	public function getTaxes(array $data = []) {
