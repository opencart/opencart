			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="pull-right">
						<button type="submit" form="form-sagepay-direct" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn"><i class="fa fa-check-circle"></i></button>
					...
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-sagepay-direct" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<span class="help-block"><?php echo $help_transaction; ?></span>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="sagepay_direct_cron_job_token"><?php echo $entry_cron_job_token; ?></label>
							<div class="col-sm-10">
								<input type="text" name="sagepay_direct_cron_job_token" value="<?php echo $sagepay_direct_cron_job_token; ?>" placeholder="<?php echo $entry_cron_job_token; ?>" id="sagepay_direct_cron_job_token" class="form-control" />
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<span id="cron-job-url"><?php echo $sagepay_direct_cron_job_url ?></span>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<span><?php echo $sagepay_direct_last_cron_job_run ?></span>
							</div>
						</div>
					</form>
				</div>
