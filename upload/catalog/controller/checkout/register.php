		...
		if (!$json) {
			...
			foreach ($custom_fields as $custom_field) {
				if ($custom_field['location'] == 'account') {
					if (empty($this->request->post['custom_field'][$custom_field['location']][$custom_field['custom_field_id']]) && $custom_field['required']) {
			...
			if ($this->config->get('config_checkout_payment_address')) {
				...
				foreach ($custom_fields as $custom_field) {
					if ($custom_field['location'] == 'address') {
						if (empty($this->request->post['payment_custom_field'][$custom_field['location']][$custom_field['custom_field_id']]) && $custom_field['required']) {
			...
			if ($this->cart->hasShipping() && !$this->request->post['address_match']) {
				...
				foreach ($custom_fields as $custom_field) {
					if ($custom_field['location'] == 'address') {
						if (empty($this->request->post['shipping_custom_field'][$custom_field['location']][$custom_field['custom_field_id']]) && $custom_field['required']) {
