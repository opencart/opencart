...
=======
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/cart_button.tpl')) {
			...
			return $this->load->view('default/template/module/cart_button.tpl', $data);
		}
	}
...
>>>>>>> 237e99f3f6ec6cc04acf8599724728aac7fcac68
...
=======
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/cart_info.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/module/cart_info.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/module/cart_info.tpl', $data));
		}
>>>>>>> 237e99f3f6ec6cc04acf8599724728aac7fcac68
	}
}