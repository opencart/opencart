...
<div id="content">
  <div class="container">
    ...
    <div class="alert alert-warning">
      <i class="fa fa-exclamation-circle"></i> <?php echo $text_url_message; ?>
    </div>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-account">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <span class="help-block"><?php echo $text_help_debug; ?></span>
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-order-status">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="realex_order_status_void_id" id="input-order-status-void" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="realex_order_status_rebated_id" id="input-order-status-rebate" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
            ...
            <div class="tab-pane" id="tab-payment">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <span class="help-block"><?php echo $text_help_dcc_settle; ?></span>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <span class="help-block"><?php echo $text_help_card_select; ?></span>
                </div>
              </div>
              <div class="form-group">
