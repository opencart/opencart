...
class SaleTax extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/opencart/report/sale_tax')
		];

		$data['save'] = $this->url->link('extension/opencart/report/sale_tax.save');
	...
	public function getReport(): string {
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination'),
			'url'   => $this->url->link('extension/opencart/report/sale_tax.report', 'code=sale_tax' . $url . '&page={page}')
		]);
