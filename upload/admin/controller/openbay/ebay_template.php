...
class ControllerOpenbayEbayTemplate extends Controller {
	...
	public function listAll() {
		...
		$data['add'] = $this->url->ssl('openbay/ebay_template/add', 'token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->ssl('openbay/ebay_template/listAll', 'token=' . $this->session->data['token'], true),
	...
	public function add() {
		...
		$data['btn_save']     = $this->url->ssl('openbay/ebay_template/add', 'token=' . $this->session->data['token'], true);
		$data['cancel']       = $this->url->ssl('openbay/ebay_template/listAll', 'token=' . $this->session->data['token'], true);
		...
		if ($this->request->post && $this->templateValidate()) {
			...
			$this->response->redirect($this->url->ssl('openbay/ebay_template/listAll&token=' . $this->session->data['token'], true));
		}
	...
	public function edit() {
		...
		$data['btn_save']     = $this->url->ssl('openbay/ebay_template/edit', 'token=' . $this->session->data['token'], true);
		$data['cancel']       = $this->url->ssl('openbay/ebay_template/listAll', 'token=' . $this->session->data['token'], true);
	...
	public function templateForm($data) {
		...
		$data['breadcrumbs'][] = array(
			'href' => $this->url->ssl('openbay/ebay/listAll', 'token=' . $this->session->data['token'], true),
			'text' => 'Profiles',
		);
