      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-ebay-settings" class="form-horizontal">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="tab-setup">
            <h4><?php echo $text_legend_app_settings; ?></h4>
            ...
            <h4><?php echo $text_legend_notify_settings; ?></h4>
            ...
            <h4><?php echo $text_legend_default_import; ?></h4>
          ...
          <div class="tab-pane" id="tab-defaults">
            <h4><?php echo $text_legend_listing; ?></h4>
            ...
            <h4><?php echo $text_legend_payments; ?></h4>
