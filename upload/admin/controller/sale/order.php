...
class Order extends \Opencart\System\Engine\Controller {
	...
	public function getList(): string {
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'url'   => $this->url->link('sale/sale.list', 'user_token=' . $this->session->data['user_token'] . $url . '&page=%d')
		]);
	...
	public function getHistory(): string {
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $limit,
			'url'   => $this->url->link('sale/order.history', 'user_token=' . $this->session->data['user_token'] . '&order_id=' . $order_id . '&page=%d')
		]);
