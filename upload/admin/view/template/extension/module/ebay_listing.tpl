...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <?php } ?>
    <div class="alert alert-info"><i class="mi mi-exclamation-circle">error</i> <?php echo $text_about; ?>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
    <div class="alert alert-warning"><i class="mi mi-exclamation-circle">error</i> <?php echo $text_register; ?>
      <button type="button" class="close" data-dismiss="alert">&times;</button>
    </div>
