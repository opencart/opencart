...
class User extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['add'] = $this->url->link('user/user.form', $url);
	...
	protected function getList(): string {
		...
		$data['action'] = $this->url->link('user/user.list', $url);
		...
		foreach ($results as $result) {
			$data['users'][] = [
				...
				'edit'       => $this->url->link('user/user.form', 'user_id=' . $result['user_id'] . $url)
			];
		}
		...
		$data['sort_username'] = $this->url->link('user/user.list', 'sort=username' . $url);
		$data['sort_name'] = $this->url->link('user/user.list', 'sort=name' . $url);
		$data['sort_email'] = $this->url->link('user/user.list', 'sort=u.email' . $url);
		$data['sort_user_group'] = $this->url->link('user/user.list', 'sort=user_group' . $url);
		$data['sort_status'] = $this->url->link('user/user.list', 'sort=u.status' . $url);
		$data['sort_date_added'] = $this->url->link('user/user.list', 'sort=u.date_added' . $url);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('user/user.list', $url . '&page={page}')
		]);
	...
	public function getAuthorize(): string {
		...
		foreach ($results as $result) {
			$data['authorizes'][] = [
				...
				'delete'     => $this->url->link('user/user.deleteAuthorize', 'user_authorize_id=' . $result['user_authorize_id'])
			];
		}
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $limit,
			'url'   => $this->url->link('user/user.authorize', 'user_id=' . $user_id . '&page={page}')
		]);
	...
	public function getLogin(): string {
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $limit,
			'url'   => $this->url->link('user/user.login', 'user_id=' . $user_id . '&page={page}')
		]);
