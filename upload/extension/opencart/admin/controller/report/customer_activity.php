...
class CustomerActivity extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('extension/opencart/report/customer_activity')
		];

		$data['save'] = $this->url->link('extension/opencart/report/customer_activity.save');
	...
	public function getReport(): string {
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'url'   => $this->url->link('extension/opencart/report/customer_activity.report', 'code=customer_activity' . $url . '&page={page}')
		]);
