...
class ControllerLocalisationOrderStatus extends Controller {
	...
	protected function getList() {
		...
		$data['sort_name'] = $this->url->link('localisation/order_status', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url);
		...
		$pagination->url = $this->url->link('localisation/order_status', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}');
