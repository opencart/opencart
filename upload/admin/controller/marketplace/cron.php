...
class Cron extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['breadcrumbs'][] = [
			...
			'href' => $this->url->link('marketplace/cron', $url)
		];

		$data['delete'] = $this->url->link('marketplace/cron.delete');
	...
	public function getList(): string {
		...
		$data['action'] = $this->url->link('marketplace/cron.list', $url);
		...
		foreach ($results as $result) {
			$data['crons'][] = [
				...
				'run'           => $this->url->link('marketplace/cron.run', 'cron_id=' . $result['cron_id']),
				'enable'        => $this->url->link('marketplace/cron.enable', 'cron_id=' . $result['cron_id']),
				'disable'       => $this->url->link('marketplace/cron.disable', 'cron_id=' . $result['cron_id'])
			];
		}
		...
		$data['sort_code'] = $this->url->link('marketplace/cron.list', 'sort=code' . $url);
		$data['sort_cycle'] = $this->url->link('marketplace/cron.list', 'sort=cycle' . $url);
		$data['sort_action'] = $this->url->link('marketplace/cron.list', 'sort=action' . $url);
		$data['sort_date_added'] = $this->url->link('marketplace/cron.list', 'sort=date_added' . $url);
		$data['sort_date_modified'] = $this->url->link('marketplace/cron.list', 'sort=date_modified' . $url);
		...
		$data['pagination'] = $this->load->controller('common/pagination', [
			...
			'page'  => $page,
			'limit' => $this->config->get('config_pagination_admin'),
			'url'   => $this->url->link('marketplace/cron.list', $url . '&page={page}')
		]);
