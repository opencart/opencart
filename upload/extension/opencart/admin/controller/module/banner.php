	...
	public function index(): void {
		...
		if (!isset($this->request->get['module_id'])) {
			$data['breadcrumbs'][] = [
				...
				'href' => $this->url->link('extension/opencart/module/banner')
			];
		} else {
			$data['breadcrumbs'][] = [
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('extension/opencart/module/banner', 'module_id=' . $this->request->get['module_id'])
			];
		}

		if (!isset($this->request->get['module_id'])) {
			$data['save'] = $this->url->link('extension/opencart/module/banner.save');
		} else {
			$data['save'] = $this->url->link('extension/opencart/module/banner.save', 'module_id=' . $this->request->get['module_id']);
		}
