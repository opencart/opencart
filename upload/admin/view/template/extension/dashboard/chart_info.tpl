<div class="panel panel-default">
  <div class="panel-heading">
    <div class="pull-right"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="mi mi-calendar">date_range</i> <i class="caret"></i></a>
    ...
    <h3 class="panel-title"><i class="mi mi-bar-chart-o">insert_chart</i> <?php echo $heading_title; ?></h3>
  </div>
