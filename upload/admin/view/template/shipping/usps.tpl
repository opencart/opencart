  ...
  <div class="panel">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-usps" class="form-horizontal">
      <div class="form-group required">
        <label class="col-lg-3 control-label" for="input-user-id"><?php echo $entry_user_id; ?></label>
        <div class="col-lg-9">
      ...
      <div class="form-group">
        <label class="col-lg-3 control-label" for="input-size"><?php echo $entry_size; ?></label>
        <div class="col-lg-9">
      ...
      <div class="form-group">
        <label class="col-lg-3 control-label" for="input-container"><?php echo $entry_container; ?></label>
        <div class="col-lg-9">
      ...
      <div class="form-group">
        <label class="col-lg-3 control-label" for="input-machinable"><?php echo $entry_machinable; ?></label>
        <div class="col-lg-9">
      ...
      <div class="form-group required">
        ...
        <div class="col-lg-9">
          <div class="row">
            <div class="col-lg-4"><input type="text" name="usps_length" value="<?php echo $usps_length; ?>" placeholder="<?php echo $entry_length; ?>" id="input-length" class="form-control" /></div>
            <div class="col-lg-4"><input type="text" name="usps_width" value="<?php echo $usps_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-width" class="form-control" /></div>
            <div class="col-lg-4"><input type="text" name="usps_height" value="<?php echo $usps_height; ?>" placeholder="<?php echo $entry_height; ?>" id="input-height" class="form-control" /></div>
          </div>          
      ...
      <div class="form-group">
        <label class="col-lg-3 control-label" for="input-tax-class"><?php echo $entry_tax; ?></label>
        <div class="col-lg-9">
