            ...
            <?php echo $content_top; ?>
                ...
                <div class="product-filter">
                    <div class="display pull-left">
                        <div class="btn-group">
                            <a id="list-view" class="btn square tooltip-item" data-toggle="tooltip" title="<?php echo $button_list_view; ?>"><i class="icon-th-list"></i></a>
                            <a id="grid-view" class="btn square tooltip-item" data-toggle="tooltip" title="<?php echo $button_grid_view; ?>"><i class="icon-th"></i></a>
                        </div>
                    </div>
                ...
                <div class="product-items layout-row-4 product-grid">
                    ...
                    <div class="span3">
                        ...
                        <div class="product-thumb transition">
                            ...
                            <div class="image">
                                <a href="<?php echo $product['href']; ?>">
                                    <img src="catalog/view/theme/default/image/placeholder.png" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" />
                                </a>
                            </div>
                            <?php } ?>
                            <div class="caption">
