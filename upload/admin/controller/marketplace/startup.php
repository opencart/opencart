...
class Startup extends \Opencart\System\Engine\Controller {
	...
	public function getList() {
		...
		$data['results'] = sprintf($this->language->get('text_pagination'), ($startup_total) ? (($page - 1) * $this->config->get('config_pagination')) + 1 : 0, ((($page - 1) * $this->config->get('config_pagination')) > ($startup_total - $this->config->get('config_pagination'))) ? $startup_total : ((($page - 1) * $this->config->get('config_pagination')) + $this->config->get('config_pagination')), $startup_total, ceil($startup_total / $this->config->get('config_pagination')));
