...
class Country extends \Opencart\System\Engine\Model {
	...
	/**
	 * Delete Country Descriptions By Country ID
	 *
	 ...
	 * $this->load->model('localisation/country');
	 *
	 * $this->model_localisation_country->deleteCountryDescriptionsByCountryId($country_id, $language_id);
	 */
	public function deleteCountryDescriptionsByCountryId(int $country_id, int $language_id): void {
